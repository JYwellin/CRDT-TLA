...
\@x{}\moduleLeftDash\@xx{ {\MODULE} OpCorrectness}\moduleRightDash\@xx{}%
\@x{ {\EXTENDS} Correctness}%
\@x{}\midbar\@xx{}%
\@x{ {\VARIABLES} buset\@s{4.1}}%
\@y{\@s{0}%
 \ensuremath{buset[r]}: the buffer of local updates generated by
 \ensuremath{r \.{\in} Replica} since the last broadcast
}%
\@xx{}%
\@x{}\midbar\@xx{}%
\@x{ OpCInit \.{\defeq}}%
\@x{\@s{16.4} \.{\land} CInit}%
\@x{\@s{16.4} \.{\land} buset \.{=} [ r \.{\in} Replica \.{\mapsto} \{ \} ]}%
\@pvspace{8.0pt}%
\@x{ OpCDo ( r ) \.{\defeq}}%
\@x{\@s{16.4} \.{\land} CDo ( r )}%
 \@x{\@s{16.4} \.{\land} buset \.{'} \.{=} [ buset {\EXCEPT} {\bang} [ r ]
 \.{=} @ \.{\cup} \{ [ r \.{\mapsto} r ,\, seq \.{\mapsto} seq [ r ] ] \}
 ]\@s{4.1}}%
\@y{%
 collect a new update
}%
\@xx{}%
\@pvspace{8.0pt}%
\@x{ OpCSend ( r ) \.{\defeq}}%
\@x{\@s{16.4} \.{\land}\@s{14.41} CSend ( r )}%
 \@x{\@s{16.4} \.{\land}\@s{14.41} uincoming \.{'} \.{=} [ x \.{\in} Replica
 \.{\mapsto}\@s{16.4}}%
\@y{\@s{0}%
 broadcast \ensuremath{buset[r]
}}%
\@xx{}%
\@x{\@s{74.72} {\IF} x \.{=} r \.{\THEN} uincoming [ x ]}%
 \@x{\@s{111.34} \.{\ELSE} uincoming [ x ] \.{\cup} \{ [ aid \.{\mapsto} [ r
 \.{\mapsto} r ,\, seq \.{\mapsto} seq [ r ] ] ,\, update \.{\mapsto} buset [
 r ] ] \} ]}%
 \@x{\@s{16.4} \.{\land}\@s{14.41} buset \.{'} \.{=} [ buset {\EXCEPT} {\bang}
 [ r ] \.{=} \{ \} ]\@s{4.1}}%
\@y{\@s{0}%
 clear \ensuremath{buset[r]
}}%
\@xx{}%
\@pvspace{8.0pt}%
\@x{ OpCDeliver ( r ,\, aid ) \.{\defeq}}%
\@x{\@s{16.4} \.{\land}\@s{4.1} CDeliver ( r ,\, aid )}%
\@x{\@s{16.4} \.{\land}\@s{4.09} {\UNCHANGED} {\langle} buset {\rangle}}%
\@x{}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Aug} 29 10:46:30 \ensuremath{CST} 2019 by \ensuremath{xhdn
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Wed} \ensuremath{Aug} 28
 19:24:11 \ensuremath{CST} 2019 by \ensuremath{xhdn
}%
\end{cpar}%
\end{lcom}%
\end{document}
