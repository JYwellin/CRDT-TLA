...
\@x{}\moduleLeftDash\@xx{ {\MODULE} Message}\moduleRightDash\@xx{}%
\@x{ {\EXTENDS} Naturals}%
\@x{}\midbar\@xx{}%
\@x{ {\CONSTANT}}%
\@x{\@s{16.4} Replica}%
...
\@x{\@s{16.4} messageSet}%
\@x{}\midbar\@xx{}%
 \@x{ Msgid ( m ) \.{\defeq} [ r \.{\mapsto} m . r ,\, seq \.{\mapsto} m . seq
 ]}%
\@x{}\midbar\@xx{}%
 \@x{ IfDeliverMsg ( m ,\, r ) \.{\defeq} Msgid ( m ) \.{\in} messageSet [ r
 ]}%
\@x{}\midbar\@xx{}%
 \@x{ Minit \.{\defeq} messageSet \.{=} [ r \.{\in} Replica \.{\mapsto} \{ \}
 ]}%
\@pvspace{8.0pt}%
\@x{ MBroadcast \.{\defeq} {\UNCHANGED} {\langle} messageSet {\rangle}}%
\@pvspace{8.0pt}%
\@x{ MDeliver ( r ,\, m ) \.{\defeq}}%
 \@x{\@s{20.5} messageSet \.{'} \.{=} [ messageSet {\EXCEPT} {\bang} [ r ]
 \.{=} @ \.{\cup} \{ Msgid ( m ) \} ]}%
\@x{}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 15:01:35 \ensuremath{CST} 2019 by \ensuremath{zfwang
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Last modified \ensuremath{Mon} May 06
 15:29:41 \ensuremath{CST} 2019 by \ensuremath{jywellin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Last modified Sun \ensuremath{Apr} 21
 18:45:44 \ensuremath{CST} 2019 by \ensuremath{xhdn
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created Sat \ensuremath{Apr} 20 22:31:38
