...
\@x{ {\VARIABLES}}%
\@x{\@s{16.4} updateset ,\,}%
\@x{\@s{16.4} last\_updateset}%
\@pvspace{8.0pt}%
\@x{ SECvars \.{\defeq} {\langle} updateset ,\, last\_updateset {\rangle}}%
\@x{}\midbar\@xx{}%
\@x{ {\CONSTANTS}}%
\@x{\@s{16.4} Replica}%
\@x{}\midbar\@xx{}%
...
\@xx{}%
\@x{ StateUpdate ( r ) \.{\defeq} updateset [ r ]\@s{71.57}}%
\@y{\@s{0}%
...
\@x{ SECInit \.{\defeq}}%
 ...
 \@x{\@s{16.4} \.{\land} last\_updateset\@s{0.87} \.{=} [ r \.{\in} Replica
 \.{\mapsto} \{ \} ]}%
\@pvspace{8.0pt}%
\@x{ SECUpdate ( r ,\, seq ) \.{\defeq}}%
 \@x{\@s{16.4} \.{\land} updateset \.{'} \.{=} [ updateset {\EXCEPT} {\bang} [
 r ] \.{=} @ \.{\cup} \{ [ r \.{\mapsto} r ,\, seq \.{\mapsto} seq ] \} ]}%
\@x{\@s{16.4} \.{\land} {\UNCHANGED} {\langle} last\_updateset {\rangle}}%
\@pvspace{8.0pt}%
\@x{ SECSend ( r ) \.{\defeq}}%
 \@x{\@s{16.4} \.{\land}\@s{14.03} last\_updateset \.{'} \.{=} [
 last\_updateset {\EXCEPT} {\bang} [ r ] \.{=} updateset [ r ] ]}%
\@x{\@s{16.4} \.{\land}\@s{14.03} {\UNCHANGED} {\langle} updateset {\rangle}}%
\@pvspace{8.0pt}%
\@x{ SECDeliver ( r ,\, m ) \.{\defeq}}%
 \@x{\@s{16.4} \.{\land} updateset \.{'} \.{=} [ updateset {\EXCEPT} {\bang} [
 r ] \.{=} @ \.{\cup} m . update ]}%
 \@x{\@s{16.4} \.{\land} last\_updateset \.{'} \.{=} [ last\_updateset
