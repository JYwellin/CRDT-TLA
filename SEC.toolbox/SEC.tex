...
\@x{}\moduleLeftDash\@xx{ {\MODULE} SEC}\moduleRightDash\@xx{}%
\@x{ {\EXTENDS} Naturals ,\, CRDTInterface}%
\@x{}\midbar\@xx{}%
...
\@y{\@s{0}%
 \ensuremath{uset[r]}: set of updates at replica \ensuremath{r \.{\in} Replica
}}%
\@xx{}%
\@x{\@s{16.4} uincoming\@s{8.20}}%
\@y{\@s{0}%
 \ensuremath{uincoming[r]}: incoming channel for updates at \ensuremath{r
 \.{\in} Replica
}}%
\@xx{}%
\@pvspace{8.0pt}%
\@x{ SECTypeOK \.{\defeq}}%
 \@x{\@s{16.4} \.{\land} uset \.{\in} [ Replica \.{\rightarrow} {\SUBSET} Aid
 ]}%
 \@x{\@s{16.4} \.{\land} uincoming \.{\in} [ Replica \.{\rightarrow} {\SUBSET}
 UMsg ]}%
\@x{}\midbar\@xx{}%
\@x{ SECInit \.{\defeq}}%
 \@x{\@s{20.5} \.{\land}\@s{4.76} uset \.{=} [ r\@s{5.87} \.{\in} Replica
 \.{\mapsto} \{ \} ]}%
 \@x{\@s{20.5} \.{\land}\@s{4.76} uincoming \.{=} [ r \.{\in} Replica
 \.{\mapsto} \{ \} ]}%
\@pvspace{8.0pt}%
\@x{ SECDo ( r ) \.{\defeq}}%
 \@x{\@s{32.85} \.{\land} uset \.{'} \.{=} [ uset {\EXCEPT} {\bang} [ r ]
 \.{=} @ \.{\cup} \{ [ r \.{\mapsto} r ,\, seq \.{\mapsto} seq [ r ] ] \} ]}%
\@x{\@s{32.85} \.{\land} {\UNCHANGED} {\langle} uincoming {\rangle}}%
\@pvspace{8.0pt}%
 \@x{ SECSend \.{\defeq}\@s{4.1} {\UNCHANGED} {\langle} uset
 {\rangle}\@s{4.1}}%
\@y{\@s{0}%
...
\@xx{}%
\@pvspace{8.0pt}%
\@x{ SECDeliver ( r ,\, aid ) \.{\defeq}\@s{4.1}}%
\@y{\@s{0}%
 choose the \ensuremath{SEC} message \ensuremath{m} according to aid
}%
\@xx{}%
 \@x{\@s{16.4} \.{\land} \.{\LET} m \.{\defeq} {\CHOOSE} m \.{\in} uincoming [
 r ] \.{:} m . aid \.{=} aid}%
\@y{\@s{0}%
 \ensuremath{m} is unique
}%
\@xx{}%
 \@x{\@s{27.51} \.{\IN} uset \.{'} \.{=} [ uset {\EXCEPT} {\bang} [ r ] \.{=}
 @ \.{\cup} m . update ]}%
\@x{\@s{16.4} \.{\land} {\UNCHANGED} {\langle} uincoming {\rangle}}%
\@x{}\midbar\@xx{}%
 \@x{ SEC \.{\defeq} \A\, r1 ,\, r2 \.{\in} Replica \.{:} uset [ r1 ] \.{=}
 uset [ r2 ] \.{\implies} Read ( r1 ) \.{=} Read ( r2 )}%
\@x{}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Jun} 18 12:22:30 \ensuremath{CST} 2019 by \ensuremath{xhdn
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Last modified \ensuremath{Mon} May 06
 16:50:42 \ensuremath{CST} 2019 by \ensuremath{jywellin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created Sun May 05 15:42:13 \ensuremath{CST}
 2019 by \ensuremath{jywellin
}%
\end{cpar}%
\end{lcom}%
\end{document}
