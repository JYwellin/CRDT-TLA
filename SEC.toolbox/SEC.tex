...
\@x{ {\VARIABLES}}%
\@x{\@s{16.4} updateset ,\,}%
\@x{\@s{16.4} prev\_updateset}%
\@pvspace{8.0pt}%
\@x{ SECvars \.{\defeq} {\langle} updateset ,\, prev\_updateset {\rangle}}%
\@x{}\midbar\@xx{}%
\@x{ {\CONSTANTS}}%
\@x{\@s{16.4} Replica}%
\@x{}\midbar\@xx{}%
\@x{ Update \.{\defeq} [ r \.{:} Replica ,\, seq \.{:} Nat ]}%
\@x{}\midbar\@xx{}%
 \@x{ OpUpdate ( r ) \.{\defeq} updateset [ r ] \.{\,\backslash\,}
 prev\_updateset [ r ]}%
\@y{\@s{0}%
 for op-based \ensuremath{CRDT
}}%
\@xx{}%
\@x{ StateUpdate ( r ) \.{\defeq} updateset [ r ]\@s{74.64}}%
\@y{\@s{0}%
...
\@x{}\midbar\@xx{}%
\@x{ SECInit \.{\defeq}}%
 \@x{\@s{16.4} \.{\land} updateset \.{=} [ r\@s{2.18} \.{\in} Replica
 \.{\mapsto} \{ \} ]}%
 \@x{\@s{16.4} \.{\land} prev\_updateset \.{=} [ r \.{\in} Replica \.{\mapsto}
 \{ \} ]}%
\@pvspace{8.0pt}%
\@x{ SECUpdate ( r ,\, seq ) \.{\defeq}}%
 \@x{\@s{16.4} \.{\land} updateset \.{'} \.{=} [ updateset {\EXCEPT} {\bang} [
 r ] \.{=} @ \.{\cup} \{ [ r \.{\mapsto} r ,\, seq \.{\mapsto} seq ] \} ]}%
\@x{\@s{16.4} \.{\land} {\UNCHANGED} {\langle} prev\_updateset {\rangle}}%
\@pvspace{8.0pt}%
\@x{ SECSend ( r ) \.{\defeq}}%
 \@x{\@s{16.4} \.{\land}\@s{14.03} prev\_updateset \.{'} \.{=} [
 prev\_updateset {\EXCEPT} {\bang} [ r ] \.{=} updateset [ r ] ]}%
\@x{\@s{16.4} \.{\land}\@s{14.03} {\UNCHANGED} {\langle} updateset {\rangle}}%
\@pvspace{8.0pt}%
\@x{ SECFlush ( r ,\, seq ) \.{\defeq}}%
 \@x{\@s{16.4} \.{\land} updateset \.{'} \.{=} [ updateset {\EXCEPT} {\bang} [
 r ] \.{=} @ \.{\cup} \{ [ r \.{\mapsto} r ,\, seq \.{\mapsto} seq ] \} ]}%
 \@x{\@s{16.4} \.{\land} prev\_updateset \.{'} \.{=} [ prev\_updateset
 {\EXCEPT} {\bang} [ r ] \.{=} @ \.{\cup} \{ [ r \.{\mapsto} r ,\, seq
 \.{\mapsto} seq ] \} ]}%
\@pvspace{8.0pt}%
...
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Last modified \ensuremath{Fri} May 31
 21:26:38 \ensuremath{CST} 2019 by \ensuremath{xhdn
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
