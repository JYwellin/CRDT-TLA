...
\@x{}\moduleLeftDash\@xx{ {\MODULE} StateCorrectness}\moduleRightDash\@xx{}%
\@x{ {\EXTENDS} Correctness}%
\@x{}\midbar\@xx{}%
\@x{ StateCInit \.{\defeq}\@s{4.1} CInit}%
\@pvspace{8.0pt}%
\@x{ StateCDo ( r ) \.{\defeq} CDo ( r )}%
\@pvspace{8.0pt}%
\@x{ StateCSend ( r ) \.{\defeq}}%
\@x{\@s{16.4} \.{\land} CSend ( r )}%
 \@x{\@s{16.4} \.{\land} uincoming \.{'} \.{=} [ x \.{\in} Replica
 \.{\mapsto}\@s{4.1}}%
\@y{\@s{0}%
 broadcast \ensuremath{delset[r]
}}%
\@xx{}%
\@x{\@s{56.21} {\IF} x \.{=} r \.{\THEN} uincoming [ x ]}%
 \@x{\@s{92.83} \.{\ELSE} uincoming [ x ] \.{\cup} \{ [ aid \.{\mapsto} [ r
 \.{\mapsto} r ,\, seq \.{\mapsto} seq [ r ] ] ,\, update \.{\mapsto} delset
 [ r ] ] \} ]}%
\@pvspace{8.0pt}%
\@x{ StateCDeliver ( r ,\, aid ) \.{\defeq}\@s{4.1} CDeliver ( r ,\, aid )}%
\@x{}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Aug} 28 19:25:47 \ensuremath{CST} 2019 by \ensuremath{xhdn
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Wed} \ensuremath{Aug} 28
 19:25:16 \ensuremath{CST} 2019 by \ensuremath{xhdn
}%
\end{cpar}%
\end{lcom}%
\end{document}
