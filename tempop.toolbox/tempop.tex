...
\@x{}\midbar\@xx{}%
\@x{ {\VARIABLES}}%
\@x{\@s{16.4} set ,\,\@s{48.30}}%
\@y{\@s{0}%
 \ensuremath{sSet[r]}: set of active \ensuremath{Element(s)} maintained by
 \ensuremath{r \.{\in} Replica
}}%
\@xx{}%
\@x{\@s{16.4} abuf ,\,\@s{41.00}}%
\@y{\@s{0}%
 \ensuremath{abuf[r]}: buffer of \ensuremath{Element(s)} added maintained by
 \ensuremath{r \.{\in} Replica
}}%
\@xx{}%
\@x{\@s{16.4} rbuf\@s{48.00}}%
\@y{\@s{0}%
...
\@xx{}%
\@x{}\midbar\@xx{}%
\@x{ Network \.{\defeq} {\INSTANCE} ReliableCausalNetwork\@s{16.4}}%
\@y{\@s{0}%
 instance a reliable causal network
}%
\@xx{}%
\@x{}\midbar\@xx{}%
\@x{ TypeOK \.{\defeq}}%
...
\@xx{}%
 ...
 \.{\lor} Do ( r )}%
\@pvspace{8.0pt}%
\@x{ Spec \.{\defeq} Init \.{\land} {\Box} [ Next ]_{ vars}\@s{8.2}}%
\@y{\@s{0}%
 specification
}%
\@xx{}%
...
\@xx{}%
 ...
 \.{\neq} \{ \}}%
 \@x{\@s{16.4} \.{\land} \.{\LET} E \.{\defeq} \{ ele \.{\in} set [ r ] \.{:}
 ele . d \.{=} d \}}%
 ...
 r ] \.{=} @ \.{\cup} E ]}%
\@pvspace{8.0pt}%
\@x{ Read ( r ) \.{\defeq}\@s{4.1}}%
\@y{\@s{0}%
 read the state of \ensuremath{r\.{\in} Replica
}}%
\@xx{}%
\@x{\@s{22.12} \{ ele . d \.{:} ele \.{\in} set [ r ] \}}%
\@pvspace{8.0pt}%
\@x{ Do ( r ) \.{\defeq}\@s{4.1}}%
\@y{\@s{0}%
 operations
...
\@xx{}%
 ...
 r ,\, seq \.{\mapsto} seq [ r ] ,\, update\@s{4.54} \.{\mapsto} OpUpdate ( r
 ) ,\,}%
 \@x{\@s{91.07} vc \.{\mapsto} [ vc {\EXCEPT} {\bang} [ r ] [ r ] \.{=} @
 \.{+} 1 ] [ r ] ,\, abuf \.{\mapsto} abuf [ r ] ,\, rbuf \.{\mapsto} rbuf [
 r ] ] )}%
 ...
 r ]\@s{0.89} \.{=} \{ \} ]}%
\@pvspace{16.0pt}%
\@x{ Receive ( r ) \.{\defeq}\@s{12.29}}%
\@y{\@s{0}%
 \ensuremath{r\.{\in} Replica} receive a message
}%
\@xx{}%
\@x{\@s{16.4} \.{\land}\@s{5.06} Network {\bang} RCDeliver ( r )}%
 \@x{\@s{16.4} \.{\land}\@s{5.06} set \.{'} \.{=} [ set {\EXCEPT} {\bang} [ r
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Jun} 10 02:23:45 \ensuremath{CST} 2019 by \ensuremath{xhdn
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Mon} \ensuremath{Jun} 10
 00:18:41 \ensuremath{CST} 2019 by \ensuremath{xhdn
}%
\end{cpar}%
\end{lcom}%
\end{document}
