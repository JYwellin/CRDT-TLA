...
\@x{}\moduleLeftDash\@xx{ {\MODULE} StateSEC}\moduleRightDash\@xx{}%
\@x{ {\EXTENDS} SEC}%
\@x{}\midbar\@xx{}%
\@x{ StateSECInit \.{\defeq}\@s{4.1} SECInit}%
\@pvspace{8.0pt}%
\@x{ StateSECDo ( r ) \.{\defeq} SECDo ( r )}%
\@pvspace{8.0pt}%
\@x{ StateSECSend ( r ) \.{\defeq}}%
\@x{\@s{16.4} \.{\land} SECSend ( r )}%
 \@x{\@s{16.4} \.{\land} uincoming \.{'} \.{=} [ x \.{\in} Replica
 \.{\mapsto}\@s{4.1}}%
\@y{\@s{0}%
 broadcast \ensuremath{uset[r]
}}%
\@xx{}%
\@x{\@s{56.21} {\IF} x \.{=} r \.{\THEN} uincoming [ x ]}%
 \@x{\@s{92.83} \.{\ELSE} uincoming [ x ] \.{\cup} \{ [ aid \.{\mapsto} [ r
 \.{\mapsto} r ,\, seq \.{\mapsto} seq [ r ] ] ,\, update \.{\mapsto} uset [
 r ] ] \} ]}%
\@pvspace{8.0pt}%
 \@x{ StateSECDeliver ( r ,\, aid ) \.{\defeq}\@s{4.1} SECDeliver ( r ,\, aid
 )}%
\@x{}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Jun} 26 13:25:05 \ensuremath{CST} 2019 by \ensuremath{xhdn
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Tue} \ensuremath{Jun} 11
 17:33:04 \ensuremath{CST} 2019 by \ensuremath{xhdn
}%
\end{cpar}%
\end{lcom}%
\end{document}
