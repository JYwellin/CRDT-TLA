...
\@pvspace{8.0pt}%
\@x{ SECvars \.{\defeq} {\langle} updateset ,\, new\_updateset {\rangle}}%
\@x{}\midbar\@xx{}%
\@x{ {\CONSTANTS}}%
\@x{\@s{16.4} Replica}%
\@x{}\midbar\@xx{}%
\@x{ Uid \.{\defeq} [ r \.{:} Replica ,\, seq \.{:} Nat ]\@s{34.70}}%
\@y{\@s{0}%
 Update Operation \ensuremath{ID
}}%
\@xx{}%
\@x{}\midbar\@xx{}%
\@x{ OpUpdate ( r ) \.{\defeq} new\_updateset [ r ]\@s{16.40}}%
\@y{\@s{0}%
 for op-based \ensuremath{CRDT
}}%
\@xx{}%
\@x{ StateUpdate ( r ) \.{\defeq} updateset [ r ]\@s{29.64}}%
\@y{\@s{0}%
 for state-based \ensuremath{CRDT
}}%
\@xx{}%
\@x{}\midbar\@xx{}%
\@x{ SECInit \.{\defeq}}%
 \@x{\@s{16.4} \.{\land} updateset \.{=} [ r \.{\in} Replica \.{\mapsto} \{ \}
 ]}%
 \@x{\@s{16.4} \.{\land} new\_updateset \.{=} [ r \.{\in} Replica \.{\mapsto}
 \{ \} ]}%
\@pvspace{8.0pt}%
\@x{ SECUpdate ( r ,\, seq ) \.{\defeq}}%
 \@x{\@s{16.4} \.{\land} updateset \.{'} \.{=} [ updateset {\EXCEPT} {\bang} [
 r ] \.{=} @ \.{\cup} \{ [ r \.{\mapsto} r ,\, seq \.{\mapsto} seq ] \} ]}%
 \@x{\@s{16.4} \.{\land} new\_updateset \.{'} \.{=} [ new\_updateset {\EXCEPT}
 {\bang} [ r ] \.{=} @ \.{\cup} \{ [ r \.{\mapsto} r ,\, seq \.{\mapsto} seq
 ] \} ]}%
\@pvspace{8.0pt}%
\@x{ SECSend ( r ) \.{\defeq}}%
 \@x{\@s{16.4} \.{\land}\@s{14.03} new\_updateset \.{'} \.{=} [ updateset
 {\EXCEPT} {\bang} [ r ] \.{=} \{ \} ]}%
\@x{\@s{16.4} \.{\land}\@s{14.03} {\UNCHANGED} {\langle} updateset {\rangle}}%
\@pvspace{8.0pt}%
\@x{ SECDeliver ( r ,\, m ) \.{\defeq}}%
 \@x{\@s{16.4} \.{\land} updateset \.{'} \.{=} [ updateset {\EXCEPT} {\bang} [
 r ] \.{=} @ \.{\cup} m . update ]}%
\@x{\@s{16.4} \.{\land} {\UNCHANGED} {\langle} new\_updateset {\rangle}}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
\ensuremath{SECFlush(r,\, seq) \.{\defeq}
}%
\end{cpar}%
\begin{cpar}{0}{T}{F}{10.0}{0}{}%
 \ensuremath{\.{\land} updateset\.{'} \.{=}} [\ensuremath{updateset}
 \ensuremath{{\EXCEPT} {\bang}[r] \.{=}} @ \ensuremath{\.{\cup} \{ [r
 \.{\mapsto} r,\, seq \.{\mapsto} seq ] \}}]
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\land} prev\_updateset\.{'} \.{=}}
 [\ensuremath{prev\_updateset} \ensuremath{{\EXCEPT} {\bang}[r] \.{=}} @
 \ensuremath{\.{\cup} \{ [r \.{\mapsto} r,\, seq \.{\mapsto} seq ] \}}]
\end{cpar}%
\end{lcom}%
\@x{}\midbar\@xx{}%
\@x{ Sameupdate ( r1 ,\, r2 ) \.{\defeq}}%
\@x{\@s{16.4} updateset [ r1 ] \.{=} updateset [ r2 ]}%
\@x{}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Jun} 04 16:16:01 \ensuremath{CST} 2019 by \ensuremath{xhdn
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
