...
vars == <<counter, buffer, seq, incoming, msg, updateset, last_updateset>>
...
SEC == \A r1, r2 \in Replica : Network!Sameupdate(r1, r2)
            => counter[r1] = counter[r2]
=============================================================================
\* Modification History
\* Last modified Mon Apr 29 16:05:33 CST 2019 by jywellin
