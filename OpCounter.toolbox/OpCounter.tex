...
\fl{}\moduleLeftDash\cl{ {\MODULE} OpCounter}\moduleRightDash\cl{}
\fl{ {\EXTENDS} Naturals ,\, Sequences ,\, Bags}
\fl{}
\fl{ {\CONSTANTS} Replica}
\fl{ {\VARIABLE} counter ,\, buffer ,\, incoming}
\fl{ vars \.{\defeq} {\langle} counter ,\, buffer ,\, incoming {\rangle}}
\fl{}
 \fl{ TypeOK}\al{7}{1}{ \.{\defeq}}\al{7}{2}{ \.{\land}}\al{7}{3}{ counter
 \.{\in} [ Replica \.{\rightarrow} Nat ]}
\fl{ \.{\land}}\al{8}{1}{ buffer \.{\in} [ Replica \.{\rightarrow} Nat ]}
\fl{}
\fl{}
 \fl{ Init \.{\defeq}}\al{11}{2}{ \.{\land}}\al{11}{3}{ counter \.{=} [ r
 \.{\in} Replica \.{\mapsto} 0 ]}
\fl{ \.{\land}}\al{12}{1}{ buffer \.{=} [ r \.{\in} Replica \.{\mapsto} 0 ]}
 \fl{ \.{\land}}\al{13}{1}{ incoming \.{=} [ r \.{\in} Replica \.{\mapsto}
 EmptyBag ]}
\fl{}
\fl{ read ( r ) \.{\defeq} counter [ r ]}
\fl{}
 \fl{ inc ( r ) \.{\defeq}}\al{17}{5}{ \.{\land}}\al{17}{6}{ counter \.{'}
 \.{=} [ counter {\EXCEPT} {\bang} [ r ] \.{=} @ \.{+} 1 ]}
 \fl{ \.{\land}}\al{18}{1}{ buffer \.{'} \.{=} [ buffer {\EXCEPT} {\bang} [ r
 ] \.{=} @ \.{+} 1 ]}
\fl{ \.{\land}}\al{19}{1}{ {\UNCHANGED} {\langle} incoming {\rangle}}
\fl{}
 \fl{ send ( r ) \.{\defeq}}\al{21}{5}{ \.{\land}}\al{21}{6}{ buffer [ r ]
 \.{\neq} 0}
 \fl{ \.{\land}}\al{22}{1}{ buffer \.{'} \.{=} [ buffer {\EXCEPT} {\bang} [ r
 ] \.{=} 0 ]}
 \fl{ \.{\land}}\al{23}{1}{ incoming}\al{23}{2}{ \.{'} \.{=} [ x \.{\in}
 Replica \.{\mapsto}}
\fl{ {\IF} x \.{=} r}
\fl{ \.{\THEN} incoming [ x ]}
\fl{ \.{\ELSE} incoming [ x ] \.{\oplus} SetToBag ( \{ buffer [ r ] \} ) ]}
\fl{ \.{\land}}\al{27}{1}{ {\UNCHANGED} {\langle} counter {\rangle}}
\fl{}
 \fl{ receive ( r ) \.{\defeq}}\al{29}{5}{ \.{\land}}\al{29}{6}{ incoming [ r
 ] \.{\neq} EmptyBag}
\fl{ \.{\land}}\al{30}{1}{ \E\, m \.{\in} BagToSet ( incoming [ r ] ) \.{:}}
 \fl{ (}\al{31}{1}{ \.{\land}}\al{31}{2}{ incoming \.{'} \.{=} [ incoming
 {\EXCEPT} {\bang} [ r ] \.{=} @ \.{\ominus} SetToBag ( \{ m \} ) ]}
 \fl{ \.{\land}}\al{32}{1}{ counter \.{'} \.{=} [ counter {\EXCEPT} {\bang} [
 r ] \.{=} @ \.{+} m ] )}
\fl{ \.{\land}}\al{33}{1}{ {\UNCHANGED} {\langle} buffer {\rangle}}
\fl{}
\fl{}\midbar\cl{}
\fl{ Next \.{\defeq}}
 \fl{ \E\, r \.{\in} Replica \.{:} inc ( r ) \.{\lor} send ( r ) \.{\lor}
 receive ( r )}
\fl{}
\fl{}\midbar\cl{}
\fl{ Spec \.{\defeq} Init \.{\land} {\Box} [ Next ]_{ vars}}
\fl{}\midbar\cl{}
 \fl{ EmptyChannel \.{\defeq} incoming \.{=} [ r \.{\in} Replica \.{\mapsto}
 EmptyBag ]}
\fl{ EmptyBuffer \.{\defeq} buffer \.{=} [ r \.{\in} Replica \.{\mapsto} 0 ]}
\fl{ EC \.{\defeq}}\al{44}{2}{ EmptyChannel \.{\land} EmptyBuffer}
 \fl{ \.{\implies} \A\, r ,\, s \.{\in} Replica \.{:} counter [ r ] \.{=}
 counter [ s ]}
\fl{}
\fl{}\bottombar\cl{}
\fl{}
