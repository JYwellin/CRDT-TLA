...
\@x{}\moduleLeftDash\@xx{ {\MODULE} OpCounter}\moduleRightDash\@xx{}%
\@x{ {\EXTENDS}}%
\@x{\@s{16.4} Naturals ,\, Sequences ,\, SEC}%
\@x{}\midbar\@xx{}%
\@x{ {\VARIABLES}}%
\@x{\@s{16.4} counter ,\,\@s{10.24}}%
\@y{\@s{0}%
 \ensuremath{counter[r]}: current value of the counter at replica
 \ensuremath{r \.{\in} Replica
}}%
\@xx{}%
\@x{\@s{16.4} buffer ,\,\@s{17.65}}%
\@y{\@s{0}%
 \ensuremath{buffer[r]}: number of increments performed since the last
 broadcast at replica \ensuremath{r \.{\in} Replica
}}%
\@xx{}%
\@x{\@s{16.4} seq ,\,\@s{29.98}}%
\@y{\@s{0}%
 \ensuremath{seq[r]}: local sequence number at replica \ensuremath{r \.{\in}
 Replica
}}%
\@xx{}%
\@x{\@s{16.4} incoming ,\,\@s{3.40}}%
\@y{\@s{0}%
 \ensuremath{incoming[r]}: incoming messages at replica \ensuremath{r \.{\in}
 Replica
}}%
\@xx{}%
\@x{\@s{16.4} msg ,\,\@s{25.89}}%
\@y{\@s{0}%
 \ensuremath{incoming[r]}: current message at replica \ensuremath{r \.{\in}
 Replica
}}%
\@xx{}%
\@x{\@s{16.4} messageSet}%
...
\@xx{}%
\@pvspace{8.0pt}%
 \@x{ vars \.{\defeq} {\langle} counter ,\, buffer ,\, seq ,\, incoming ,\,
 msg ,\, messageSet ,\, SECvars {\rangle}}%
\@pvspace{8.0pt}%
 \@x{ Msg \.{\defeq} [ r \.{:} Replica ,\, buf \.{:} Nat ,\, seq \.{:} Nat ,\,
 update \.{:} {\SUBSET} Update ]}%
\@x{}\midbar\@xx{}%
\@x{ Network \.{\defeq} {\INSTANCE} ReliableNetwork}%
\@x{}\midbar\@xx{}%
\@x{ TypeOK \.{\defeq}}%
 \@x{\@s{16.4} \.{\land}\@s{9.74} counter \.{\in} [ Replica \.{\rightarrow}
 Nat ]}%
 \@x{\@s{16.4} \.{\land}\@s{9.74} buffer \.{\in} [ Replica \.{\rightarrow} Nat
 ]}%
\@x{\@s{16.4} \.{\land}\@s{9.74} seq \.{\in} [ Replica \.{\rightarrow} Nat ]}%
\@x{}\midbar\@xx{}%
\@x{ Init \.{\defeq}}%
\@x{\@s{16.4} \.{\land} counter \.{=} [ r \.{\in} Replica \.{\mapsto} 0 ]}%
\@x{\@s{16.4} \.{\land} buffer \.{=} [ r \.{\in} Replica \.{\mapsto} 0 ]}%
\@x{\@s{16.4} \.{\land} seq \.{=} [ r \.{\in} Replica \.{\mapsto} 0 ]}%
\@x{\@s{16.4} \.{\land} Network {\bang} RInit}%
\@x{\@s{16.4} \.{\land} SECInit}%
\@pvspace{8.0pt}%
\@x{ Read ( r ) \.{\defeq} counter [ r ]}%
\@pvspace{8.0pt}%
\@x{ Inc ( r ) \.{\defeq}}%
 \@x{\@s{18.53} \.{\land} counter \.{'} \.{=} [ counter {\EXCEPT} {\bang} [ r
 ] \.{=} @ \.{+} 1 ]}%
 \@x{\@s{18.53} \.{\land} buffer \.{'} \.{=} [ buffer {\EXCEPT} {\bang} [ r ]
 \.{=} @ \.{+} 1 ]}%
 \@x{\@s{18.53} \.{\land} seq \.{'} \.{=} [ seq {\EXCEPT} {\bang} [ r ] \.{=}
 @ \.{+} 1 ]}%
\@x{\@s{18.53} \.{\land} SECUpdate ( r ,\, seq [ r ] )}%
 \@x{\@s{18.53} \.{\land} {\UNCHANGED} {\langle} incoming ,\, msg ,\,
 messageSet {\rangle}}%
\@pvspace{8.0pt}%
\@x{ Send ( r ) \.{\defeq}}%
\@x{\@s{21.98} \.{\land} buffer [ r ] \.{\neq} 0}%
 \@x{\@s{21.98} \.{\land} buffer \.{'} \.{=} [ buffer {\EXCEPT} {\bang} [ r ]
 \.{=} 0 ]}%
 \@x{\@s{21.98} \.{\land} Network {\bang} RBroadcast ( r ,\, [ r \.{\mapsto} r
 ,\, buf \.{\mapsto} buffer [ r ] ,\, seq \.{\mapsto} seq [ r ] ,\, update
 \.{\mapsto} OpUpdate ( r ) ] )}%
\@x{\@s{21.98} \.{\land} SECSend ( r )}%
\@x{\@s{21.98} \.{\land} {\UNCHANGED} {\langle} counter ,\, seq {\rangle}}%
\@pvspace{8.0pt}%
\@x{ Receive ( r ) \.{\defeq}}%
\@x{\@s{16.4} \.{\land}\@s{5.06} Network {\bang} RDeliver ( r )}%
\@x{\@s{16.4} \.{\land}\@s{5.06} SECDeliver ( r ,\, msg \.{'} [ r ] )}%
 \@x{\@s{16.4} \.{\land}\@s{5.06} counter \.{'} \.{=} [ counter {\EXCEPT}
 {\bang} [ r ] \.{=} @ \.{+} msg \.{'} [ r ] . buf ]}%
 \@x{\@s{16.4} \.{\land}\@s{5.06} {\UNCHANGED} {\langle} buffer ,\, seq
 {\rangle}}%
\@x{}\midbar\@xx{}%
 \@x{ Next \.{\defeq} \E\, r \.{\in} Replica \.{:} Inc ( r ) \.{\lor} Send ( r
 ) \.{\lor} Receive ( r )}%
\@x{}\midbar\@xx{}%
\@x{ Spec \.{\defeq} Init \.{\land} {\Box} [ Next ]_{ vars}}%
\@x{}\midbar\@xx{}%
\@x{ EmptyBuffer \.{\defeq} buffer \.{=} [ r \.{\in} Replica \.{\mapsto} 0 ]}%
\@x{ EC \.{\defeq} Network {\bang} EmptyChannel \.{\land} EmptyBuffer}%
 \@x{\@s{58.88} \.{\implies} \A\, r1 ,\, r2 \.{\in} Replica \.{:} Read ( r1 )
 \.{=} Read ( r2 )}%
\@pvspace{8.0pt}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 09:23:01 \ensuremath{CST} 2019 by \ensuremath{zfwang
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Last modified \ensuremath{Tue} May 07
 00:57:30 \ensuremath{CST} 2019 by \ensuremath{xhdn
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Last modified \ensuremath{Mon} May 06
 15:51:30 \ensuremath{CST} 2019 by \ensuremath{jywellin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Fri} \ensuremath{Mar} 22
 20:43:27 \ensuremath{CST} 2019 by \ensuremath{jywellin
}%
\end{cpar}%
\end{lcom}%
\end{document}
