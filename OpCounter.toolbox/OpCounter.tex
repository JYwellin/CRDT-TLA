...
\@x{\@s{21.98} \.{\land} buffer [ r ] \.{\neq} 0}%
 ...
 ,\, seq \.{\mapsto} seq [ r ] ,\, update \.{\mapsto} OpUpdate ( r ) ,\, buf
 \.{\mapsto} buffer [ r ] ] )}%
...
\@x{ EC \.{\defeq} Network {\bang} EmptyChannel \.{\land} EmptyBuffer}%
 \@x{\@s{58.88} \.{\implies} \A\, r1 ,\, r2 \.{\in} Replica \.{:} counter [ r1
 ] \.{=} counter [ r2 ]}%
\@pvspace{8.0pt}%
 \@x{ SEC \.{\defeq} \A\, r1 ,\, r2 \.{\in} Replica \.{:} Sameupdate ( r1 ,\,
 r2 ) \.{\implies} counter [ r1 ] \.{=} counter [ r2 ]}%
\@x{}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 16:52:35 \ensuremath{CST} 2019 by \ensuremath{zfwang
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
