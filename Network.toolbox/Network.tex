...
\@x{}\moduleLeftDash\@xx{ {\MODULE} Network}\moduleRightDash\@xx{}%
\@x{ {\EXTENDS} Bags ,\, Message}%
\@x{}\midbar\@xx{}%
\@x{ {\VARIABLES}}%
\@x{\@s{16.4} incoming ,\,}%
\@x{\@s{16.4} msg}%
\@pvspace{8.0pt}%
\@x{ vars \.{\defeq} {\langle} incoming ,\, msg {\rangle}}%
\@x{}\midbar\@xx{}%
\@x{ {\CONSTANTS}}%
\@x{\@s{16.4} Msg}%
\@pvspace{8.0pt}%
\@x{ NotMsg \.{\defeq} {\CHOOSE} m \.{:} m \.{\notin} Msg}%
\@x{}\midbar\@xx{}%
\@x{ NInit \.{\defeq}}%
\@x{\@s{16.4} \.{\land} Minit}%
 \@x{\@s{16.4} \.{\land} incoming \.{=} [ r \.{\in} Replica \.{\mapsto}
 EmptyBag ]}%
 \@x{\@s{16.4} \.{\land} msg \.{=} [ r\@s{1.08} \.{\in} Replica \.{\mapsto}
 NotMsg ]}%
\@pvspace{8.0pt}%
\@x{ NBroadcast ( r ,\, m ) \.{\defeq}}%
\@x{\@s{16.4} \.{\land} incoming \.{'} \.{=} [ x \.{\in} Replica \.{\mapsto}}%
\@x{\@s{100.71} {\IF} x \.{=} r}%
\@x{\@s{100.71} \.{\THEN} incoming [ x ]}%
\@x{\@s{100.71} \.{\ELSE} incoming [ x ] \.{\oplus} SetToBag ( \{ m \} ) ]}%
\@x{\@s{16.4} \.{\land} MBroadcast}%
\@x{\@s{16.4} \.{\land} {\UNCHANGED} {\langle} msg {\rangle}}%
\@pvspace{8.0pt}%
\@x{ NDeliver ( r ) \.{\defeq}}%
\@x{\@s{16.4} \.{\land} incoming [ r ] \.{\neq} EmptyBag}%
\@x{\@s{16.4} \.{\land} \E\, m \.{\in} BagToSet ( incoming [ r ] ) \.{:}}%
 \@x{\@s{35.71} \.{\land} msg \.{'} \.{=} [ msg {\EXCEPT} {\bang} [ r ] \.{=}
 m ]}%
\@x{\@s{35.71} \.{\land} MDeliver ( r ,\, m )}%
\@x{\@s{16.4} \.{\land} {\UNCHANGED} {\langle} incoming {\rangle}}%
\@x{}\midbar\@xx{}%
 \@x{ EmptyChannel \.{\defeq} incoming \.{=} [ r \.{\in} Replica \.{\mapsto}
 EmptyBag ]}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
...
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Last modified \ensuremath{Fri} May 17
 00:25:13 \ensuremath{CST} 2019 by \ensuremath{zfwang
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Last modified \ensuremath{Mon} May 06
 15:30:04 \ensuremath{CST} 2019 by \ensuremath{jywellin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Last modified Sun \ensuremath{Apr} 21
 21:44:03 \ensuremath{CST} 2019 by \ensuremath{xhdn
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Mon} \ensuremath{Mar} 25
 20:24:02 \ensuremath{CST} 2019 by \ensuremath{jywellin
}%
\end{cpar}%
\end{lcom}%
\end{document}
