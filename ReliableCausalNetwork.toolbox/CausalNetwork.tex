...
\@x{\@s{54.04} \.{\lor} s \.{=} m . r}%
\@x{\@s{35.71} \.{\land} \.{\lor} m . vc [ m . r ] \.{=} vc [ r ] [ m . r ]}%
\@x{\@s{46.82} \.{\lor} m . vc [ m . r ] \.{=} vc [ r ] [ m . r ] \.{+} 1}%
 \@x{\@s{35.71} \.{\land} vc \.{'} \.{=} [ vc {\EXCEPT} {\bang} [ r ] [ m . r
 ] \.{=} m . vc [ m . r ] ]}%
\@x{\@s{35.71} \.{\land} msg \.{'} \.{=} m}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Jun} 03 16:17:56 \ensuremath{CST} 2019 by \ensuremath{xhdn
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
