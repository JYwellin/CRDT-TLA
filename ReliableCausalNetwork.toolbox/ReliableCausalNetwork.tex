...
\@x{ {\EXTENDS} CausalNetwork}%
\@x{}\midbar\@xx{}%
\@x{ RCNCausallyReady ( r ,\, m ) \.{\defeq}\@s{4.1}}%
\@y{\@s{0}%
...
\@x{\@s{16.4} \.{\LET} mr \.{\defeq} sender ( m )}%
 \@x{\@s{16.4} \.{\IN} \.{\land} ts ( m ) [ mr ] \.{=} vc [ r ] [ mr ] \.{+}
 1\@s{4.1}}%
\@y{\@s{0}%
...
\@xx{}%
 ...
 \.{:} ts ( m ) [ s ] \.{\leq} vc [ r ] [ s ]}%
\@pvspace{8.0pt}%
\@x{ RCNDeliver ( r ) \.{\defeq}}%
\@x{\@s{16.4} \.{\land} incoming [ r ] \.{\neq} \{ \}}%
\@x{\@s{16.4} \.{\land} \E\, m \.{\in} incoming [ r ] \.{:}}%
\@x{\@s{35.71} \.{\land} RCNCausallyReady ( r ,\, m )}%
...
\@xx{}%
 ...
 \.{=} m ]}%
 \@x{\@s{35.71} \.{\land} incoming \.{'} \.{=} [ incoming {\EXCEPT} {\bang} [
 r ] \.{=} @ \.{\,\backslash\,} \{ m \} ]\@s{8.2}}%
\@y{\@s{0}%
 delete \ensuremath{m
}}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Jun} 18 12:41:57 \ensuremath{CST} 2019 by \ensuremath{xhdn
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
