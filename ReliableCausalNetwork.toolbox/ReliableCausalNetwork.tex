...
\@x{ {\EXTENDS} CausalNetwork ,\, Message}%
\@pvspace{8.0pt}%
\@x{ RCvars \.{\defeq} {\langle} incoming ,\, lmsg ,\, dmsg ,\, vc {\rangle}}%
\@x{}\midbar\@xx{}%
\@x{ RCInit \.{\defeq} \.{\land} CInit}%
\@x{\@s{49.89} \.{\land} MInit}%
\@pvspace{8.0pt}%
\@x{ RCBroadcast ( r ,\, m ) \.{\defeq} \.{\land} CBroadcast ( r ,\, m )}%
\@x{\@s{104.33} \.{\land} MBroadcast}%
\@pvspace{8.0pt}%
\@x{ RCDeliver ( r ) \.{\defeq}}%
\@x{\@s{16.4} \.{\land} incoming [ r ] \.{\neq} EmptyBag}%
\@x{\@s{16.4} \.{\land} \E\, m \.{\in} BagToSet ( incoming [ r ] ) \.{:}}%
\@x{\@s{35.71} \.{\land} {\lnot} IfDeliverMsg ( m ,\, r )}%
\@x{\@s{35.71} \.{\land} \A\, s \.{\in} Replica \.{:}}%
\@x{\@s{54.04} \.{\lor} m . vc [ s ] \.{\leq} vc [ r ] [ s ]}%
\@x{\@s{54.04} \.{\lor} s \.{=} m . r}%
\@x{\@s{35.71} \.{\land} m . vc [ m . r ] \.{=} vc [ r ] [ m . r ] \.{+} 1}%
 \@x{\@s{35.71} \.{\land} vc \.{'} \.{=} [ vc {\EXCEPT} {\bang} [ r ] [ m . r
 ] \.{=} @ \.{+} 1 ]}%
\@x{\@s{35.71} \.{\land} lmsg \.{'} \.{=}\@s{4.1} m}%
\@x{\@s{35.71} \.{\land} MDeliver ( r ,\, m )}%
\@x{\@s{16.4} \.{\land} {\UNCHANGED} {\langle} incoming {\rangle}}%
\@pvspace{8.0pt}%
\@x{ RCDo \.{\defeq} {\UNCHANGED} RCvars}%
\@x{}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 00:47:56 \ensuremath{CST} 2019 by \ensuremath{xhdn
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
