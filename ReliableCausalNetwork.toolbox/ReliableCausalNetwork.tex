...
\@x{}\midbar\@xx{}%
\@x{ RCInit \.{\defeq} \.{\land} NInit}%
 \@x{\@s{49.89} \.{\land} vc \.{=} [ r \.{\in} Replica \.{\mapsto} InitVector
 ]}%
\@pvspace{8.0pt}%
\@x{ RCBroadcast ( r ,\, m ) \.{\defeq} \.{\land} NBroadcast ( r ,\, m )}%
 \@x{\@s{104.33} \.{\land} vc \.{'} \.{=} [ vc {\EXCEPT} {\bang} [ r ] [ r ]
 \.{=} @ \.{+} 1 ]}%
\@pvspace{8.0pt}%
\@x{ RCDeliver ( r ) \.{\defeq}}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Jun} 03 15:49:22 \ensuremath{CST} 2019 by \ensuremath{xhdn
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
