...
DoDel(r) == 
    \E del \in Char:
        ...
        /\ UNCHANGED <<chins, tree, incoming, msg, updateset, vc>>
(* 
do transitions
*)     
Do(r) == 
...
*)     
Send(r) ==
     /\ Network!Broadcast(r, [r |-> r, seq |-> tcurrent, vc |-> vc', tombbuf |-> tombbuf[r], insbuf |-> insbuf[r]])
...
*)
EmptyBuffer == tombbuf = [r \in Replica |-> 0 ] /\ insbuf = [r \in Replica |-> 0 ]
...
\* Last modified Tue Apr 16 20:57:08 CST 2019 by jywellin
