...
\@x{}\moduleLeftDash\@xx{ {\MODULE} RGA}\moduleRightDash\@xx{}%
 \@x{ {\EXTENDS} Integers ,\, Sequences ,\, Naturals ,\, TLC ,\, InsertTree
 ,\, SEC}%
\@x{}\midbar\@xx{}%
\@x{ {\VARIABLES}}%
\@x{\@s{16.4} tree ,\,}%
...
\@x{\@s{16.4} chins ,\,}%
\@x{\@s{16.4} seq ,\,}%
\@x{\@s{16.4} incoming ,\,\@s{20.5}}%
\@y{\@s{0}%
 network variable
}%
\@xx{}%
\@x{\@s{16.4} msg ,\,\@s{42.98}}%
\@y{\@s{0}%
 network variable
}%
\@xx{}%
\@x{\@s{16.4} messageset ,\,\@s{12.51}}%
\@y{\@s{0}%
 network variable
}%
\@xx{}%
...
\@xx{}%
\@pvspace{8.0pt}%
 \@x{ vars \.{\defeq} {\langle} tree ,\, tomb ,\, insbuf ,\, tombbuf ,\, chins
 ,\, seq ,\, incoming ,\, msg ,\, messageset ,\, vc ,\, SECvars {\rangle}}%
\@x{}\midbar\@xx{}%
\@x{ vector \.{\defeq} [ Replica \.{\rightarrow} Nat ]}%
\@pvspace{8.0pt}%
 \@x{ Msg \.{\defeq} [ r \.{:} Replica ,\, vc \.{:} vector ,\, seq \.{:} Nat
 ,\, update \.{:} {\SUBSET} Update ,\,}%
 \@x{\@s{40.20} tombbuf \.{:} {\SUBSET} node ,\, insbuf \.{:} {\SUBSET} Char
 ]}%
\@pvspace{8.0pt}%
\@x{ List \.{\defeq} Seq ( Char )}%
\@pvspace{8.0pt}%
\@x{ {\RECURSIVE} maxtime ( \_ ,\, \_ )}%
 \@x{ maxtime ( tr ,\, curmax ) \.{\defeq} {\IF} tr \.{=} \{ \} \.{\THEN}
 curmax}%
 \@x{\@s{120.75} \.{\ELSE}\@s{4.1} \.{\LET} t \.{\defeq} {\CHOOSE} x \.{\in}
 tr \.{:} {\TRUE}}%
 \@x{\@s{120.75} \.{\IN} maxtime ( tr \.{\,\backslash\,} \{ t \} ,\, Nummax (
 ( t . ts ) . time ,\, curmax ) )}%
\@x{}\midbar\@xx{}%
\@x{ Network \.{\defeq} {\INSTANCE} CausalNetwork}%
\@x{}\midbar\@xx{}%
\@x{ TypeOK \.{\defeq}}%
 \@x{\@s{16.4} \.{\land}\@s{9.74} tree\@s{5.37} \.{\in} [ Replica
 \.{\rightarrow} {\SUBSET} node ]}%
 \@x{\@s{16.4} \.{\land}\@s{9.74} tomb \.{\in} [ Replica \.{\rightarrow}
 {\SUBSET} Char ]}%
 \@x{\@s{16.4} \.{\land}\@s{9.74} insbuf \.{\in} [ Replica \.{\rightarrow}
 {\SUBSET} node ]}%
 \@x{\@s{16.4} \.{\land}\@s{9.74} tombbuf \.{\in} [ Replica \.{\rightarrow}
 {\SUBSET} Char ]}%
\@x{\@s{16.4} \.{\land}\@s{9.74} chins \.{\in} {\SUBSET} Char}%
\@x{}\midbar\@xx{}%
\@pvspace{8.0pt}%
\@x{ Init \.{\defeq}}%
\@x{\@s{16.4} \.{\land} Network {\bang} Init}%
\@x{\@s{16.4} \.{\land} SECInit}%
 \@x{\@s{16.4} \.{\land} tree\@s{5.37} \.{=} [ r \.{\in} Replica \.{\mapsto}
 \{ \} ]}%
\@x{\@s{16.4} \.{\land} tomb \.{=} [ r \.{\in} Replica \.{\mapsto} \{ \} ]}%
\@x{\@s{16.4} \.{\land} insbuf \.{=} [ r \.{\in} Replica \.{\mapsto} \{ \} ]}%
 \@x{\@s{16.4} \.{\land} tombbuf \.{=} [ r \.{\in} Replica \.{\mapsto} \{ \}
 ]}%
\@x{\@s{16.4} \.{\land} chins \.{=} Char}%
\@x{\@s{16.4} \.{\land} seq \.{=} [ r \.{\in} Replica \.{\mapsto} 0 ]}%
\@pvspace{16.0pt}%
\@x{ DoIns ( r ) \.{\defeq}}%
\@x{\@s{16.4} \E\, ins \.{\in} node \.{:}}%
 \@x{\@s{27.72} \.{\land} ins . parent \.{\in} Readtree2set ( tree [ r ] )
 \.{\cup} \{\@w{o} \}}%
 \@x{\@s{27.72} \.{\land} ins . ts\@s{4.1} \.{=} [ r \.{\mapsto} r ,\, time
 \.{\mapsto} maxtime ( tree [ r ] ,\, 1 ) ]}%
\@x{\@s{27.72} \.{\land} ins . ch \.{\in} chins}%
 \@x{\@s{27.72} \.{\land} chins \.{'}\@s{0.73} \.{=} chins \.{\,\backslash\,}
 \{ ins . ch \}}%
 \@x{\@s{27.72} \.{\land} tree \.{'} \.{=}\@s{4.1} [ tree\@s{4.1} {\EXCEPT}
 {\bang} [ r ] \.{=} @ \.{\cup} \{ ins \} ]}%
 \@x{\@s{27.72} \.{\land} insbuf \.{'} \.{=} [ insbuf {\EXCEPT} {\bang} [ r ]
 \.{=} @ \.{\cup} \{ ins \} ]}%
 \@x{\@s{27.72} \.{\land} seq \.{'} \.{=} [ seq {\EXCEPT} {\bang} [ r ] \.{=}
 @ \.{+} 1 ]}%
\@x{\@s{27.72} \.{\land} SECUpdate ( r ,\, seq [ r ] )}%
 \@x{\@s{27.72} \.{\land} {\UNCHANGED} {\langle} incoming ,\, msg ,\,
 messageset ,\, vc ,\, tomb ,\, tombbuf {\rangle}}%
\@pvspace{16.0pt}%
\@x{ DoDel ( r ) \.{\defeq}}%
\@x{\@s{16.4} \E\, del \.{\in} Char \.{:}}%
\@x{\@s{27.72} \.{\land} del \.{\in} Readtree2set ( tree [ r ] )}%
\@x{\@s{27.72} \.{\land} {\lnot} del\@s{4.68} \.{\in} tomb [ r ]}%
 \@x{\@s{27.72} \.{\land} tomb \.{'} \.{=} [ tomb {\EXCEPT} {\bang} [ r ]
 \.{=} @ \.{\cup} \{ del \} ]}%
 \@x{\@s{27.72} \.{\land} tombbuf \.{'} \.{=} [ tombbuf {\EXCEPT} {\bang} [ r
 ] \.{=} @ \.{\cup} \{ del \} ]}%
 \@x{\@s{27.72} \.{\land} seq \.{'} \.{=} [ seq {\EXCEPT} {\bang} [ r ] \.{=}
 @ \.{+} 1 ]}%
\@x{\@s{27.72} \.{\land} SECUpdate ( r ,\, seq [ r ] )}%
 \@x{\@s{27.72} \.{\land} {\UNCHANGED} {\langle} chins ,\, tree ,\, insbuf ,\,
 incoming ,\, msg ,\, messageset ,\, vc {\rangle}}%
\begin{lcom}{0}%
...
\end{lcom}%
\@x{ Do ( r ) \.{\defeq}}%
\@x{\@s{22.47} \.{\lor} DoIns ( r )}%
\@x{\@s{22.47} \.{\lor} DoDel ( r )}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
send transitions
...
\end{lcom}%
\@x{ Send ( r ) \.{\defeq}}%
\@x{\@s{25.87} \.{\land} \.{\lor} tombbuf [ r ] \.{\neq} \{ \}}%
\@x{\@s{36.98} \.{\lor} insbuf [ r ] \.{\neq} \{ \}}%
 \@x{\@s{25.87} \.{\land} Network {\bang} Broadcast ( r ,\, [ r \.{\mapsto} r
 ,\, seq \.{\mapsto} seq [ r ] ,\,}%
 \@x{\@s{125.57} vc \.{\mapsto} [ vc {\EXCEPT} {\bang} [ r ] [ r ] \.{=} @
 \.{+} 1 ] [ r ] ,\, update \.{\mapsto} OpUpdate ( r ) ,\,}%
 \@x{\@s{125.57} tombbuf \.{\mapsto} tombbuf [ r ] ,\, insbuf \.{\mapsto}
 insbuf [ r ] ] )}%
\@x{\@s{25.87} \.{\land} SECSend ( r )}%
 \@x{\@s{25.87} \.{\land} tombbuf \.{'} \.{=} [ tombbuf {\EXCEPT} {\bang} [ r
 ] \.{=} \{ \} ]}%
 \@x{\@s{25.87} \.{\land} insbuf \.{'} \.{=} [ insbuf {\EXCEPT} {\bang} [ r ]
 \.{=} \{ \} ]}%
 \@x{\@s{25.87} \.{\land} {\UNCHANGED} {\langle} chins ,\, seq ,\, tree ,\,
 tomb {\rangle}}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{lcom}%
\@x{ Receive ( r ) \.{\defeq}}%
\@x{\@s{16.4} \.{\land}\@s{5.06} Network {\bang} Deliver ( r )}%
\@x{\@s{16.4} \.{\land}\@s{5.06} SECDeliver ( r ,\, msg \.{'} [ r ] )}%
 \@x{\@s{16.4} \.{\land}\@s{5.06} tree \.{'}\@s{5.37} \.{=}\@s{4.1} [
 tree\@s{4.1} {\EXCEPT} {\bang} [ r ] \.{=} @ \.{\cup} msg \.{'} [ r ] .
 insbuf ]}%
 \@x{\@s{16.4} \.{\land}\@s{5.06} tomb \.{'} \.{=} [ tomb {\EXCEPT} {\bang} [
 r ] \.{=} @ \.{\cup} msg \.{'} [ r ] . tombbuf ]}%
 \@x{\@s{16.4} \.{\land}\@s{5.06} {\UNCHANGED} {\langle} chins ,\, seq ,\,
 tombbuf ,\, insbuf {\rangle}}%
\@x{}\midbar\@xx{}%
\@x{ Next \.{\defeq}}%
 \@x{\@s{12.29} \E\, r \.{\in} Replica \.{:} Do ( r ) \.{\lor} Send ( r )
 \.{\lor} Receive ( r )}%
\@pvspace{8.0pt}%
\@x{}\midbar\@xx{}%
...
\end{cpar}%
\end{lcom}%
 \@x{ EmptyBuffer \.{\defeq} tombbuf \.{=} [ r \.{\in} Replica \.{\mapsto} \{
 \} ] \.{\land} insbuf \.{=} [ r \.{\in} Replica \.{\mapsto} \{ \} ]}%
\@pvspace{8.0pt}%
\@x{ EC \.{\defeq} Network {\bang} EmptyChannel \.{\land} EmptyBuffer}%
 \@x{\@s{42.48} \.{\implies}\@s{4.1} \A\, r1 ,\, r2\@s{4.1} \.{\in} Replica
 \.{:}}%
 \@x{\@s{70.33} Readtree2list ( tree [ r1 ] ,\,\@w{o} ,\, tomb [ r1 ] ,\, \{
 \} ) \.{=} Readtree2list ( tree [ r2 ] ,\,\@w{o} ,\, tomb [ r2 ] ,\, \{ \}
 )}%
\@pvspace{8.0pt}%
 \@x{ SEC \.{\defeq} \E\, r1 ,\, r2 \.{\in} Replica \.{:} Sameupdate ( r1 ,\,
 r2 )}%
 \@x{\@s{57.41} \.{\implies} Readtree2list ( tree [ r1 ] ,\,\@w{o} ,\, tomb [
 r1 ] ,\, \{ \} ) \.{=} Readtree2list ( tree [ r2 ] ,\,\@w{o} ,\, tomb [ r2 ]
 ,\, \{ \} )}%
\@x{}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
...
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Last modified \ensuremath{Tue} May 07
 01:27:02 \ensuremath{CST} 2019 by \ensuremath{xhdn
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Last modified \ensuremath{Mon} May 06
 16:52:19 \ensuremath{CST} 2019 by \ensuremath{jywellin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Last modified \ensuremath{Thu}
 \ensuremath{Jan} 10 15:34:04 \ensuremath{CST} 2019 by \ensuremath{jywellins
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Tue} \ensuremath{Nov} 06
 15:55:23 \ensuremath{CST} 2018 by \ensuremath{xhdn
}%
\end{cpar}%
\end{lcom}%
\end{document}
