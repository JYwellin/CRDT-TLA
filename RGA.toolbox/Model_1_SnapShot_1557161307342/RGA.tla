...
Msg == [r : Replica, vc: vector, seq : Nat, update : SUBSET Update, tombbuf : SUBSET node, insbuf : SUBSET Char]
...
Send(r) ==
     /\ \/ tombbuf[r] # {}
        \/ insbuf[r] # {}
     /\ Network!NBroadcast(r, [r |-> r, seq |-> seq[r], vc |-> [vc EXCEPT ![r][r] = @ + 1][r], update|-> OpUpdate(r), tombbuf |-> tombbuf[r], insbuf |-> insbuf[r]])
     /\ SECSend(r)
...
\* Last modified Tue May 07 00:48:17 CST 2019 by xhdn
