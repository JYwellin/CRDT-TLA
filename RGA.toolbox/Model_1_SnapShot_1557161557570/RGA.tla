...
Send(r) ==
     /\ \/ tombbuf[r] # {}
        \/ insbuf[r] # {}
     /\ Network!Broadcast(r, [r |-> r, seq |-> seq[r], vc |-> [vc EXCEPT ![r][r] = @ + 1][r], update|-> OpUpdate(r), tombbuf |-> tombbuf[r], insbuf |-> insbuf[r]])
     /\ SECSend(r)
...
\* Last modified Tue May 07 00:49:01 CST 2019 by xhdn
