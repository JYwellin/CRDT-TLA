...
\@x{ {\EXTENDS} BasicNetwork}%
\@x{}\midbar\@xx{}%
\@x{ rnVars \.{\defeq} {\langle} incoming ,\, lmsg {\rangle}}%
\@x{}\midbar\@xx{}%
\@x{ RNInit \.{\defeq} BNInit}%
\@pvspace{8.0pt}%
\@x{ RNBroadcast ( r ,\, m ) \.{\defeq} BNBroadcast ( r ,\, m )}%
\@pvspace{8.0pt}%
\@x{ RNDeliver ( r ) \.{\defeq}}%
\@x{\@s{16.4} \.{\land} incoming [ r ] \.{\neq} \{ \}}%
\@x{\@s{16.4} \.{\land} \E\, m \.{\in} incoming [ r ] \.{:}}%
 \@x{\@s{31.61} \.{\land} lmsg \.{'} \.{=} [ lmsg {\EXCEPT} {\bang} [ r ]
 \.{=} m ]\@s{4.1}}%
\@y{\@s{0}%
 choose \ensuremath{m} from \ensuremath{incoming[r]} non-deterministically
}%
\@xx{}%
 \@x{\@s{31.61} \.{\land} incoming \.{'} \.{=} [ incoming {\EXCEPT} {\bang} [
 r ] \.{=} @ \.{\,\backslash\,} \{ m \} ]\@s{4.1}}%
\@y{\@s{0}%
 delete \ensuremath{m
}}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Jun} 17 13:01:38 \ensuremath{CST} 2019 by \ensuremath{xhdn
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
