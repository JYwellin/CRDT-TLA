...
\@x{}\moduleLeftDash\@xx{ {\MODULE} ReliableNetwork}\moduleRightDash\@xx{}%
\@x{ {\EXTENDS} BasicNetwork ,\, Message}%
\@pvspace{8.0pt}%
\@x{ Rvars \.{\defeq} {\langle} incoming ,\, lmsg ,\, dmsg {\rangle}}%
\@x{}\midbar\@xx{}%
\@x{ RInit \.{\defeq} \.{\land} NInit}%
\@x{\@s{42.99} \.{\land} MInit}%
\@pvspace{8.0pt}%
\@x{ RBroadcast ( r ,\, m ) \.{\defeq} \.{\land} NBroadcast ( r ,\, m )}%
\@x{\@s{97.43} \.{\land} MBroadcast}%
\@pvspace{8.0pt}%
\@x{ RDeliver ( r ) \.{\defeq}}%
\@x{\@s{16.4} \.{\land} incoming [ r ] \.{\neq} EmptyBag}%
\@x{\@s{16.4} \.{\land} \E\, m \.{\in} BagToSet ( incoming [ r ] ) \.{:}}%
\@x{\@s{31.61} \.{\land} {\lnot} IfDeliverMsg ( m ,\, r )}%
\@x{\@s{31.61} \.{\land} lmsg \.{'} \.{=} m}%
\@x{\@s{31.61} \.{\land} MDeliver ( r ,\, m )}%
\@x{\@s{16.4} \.{\land} {\UNCHANGED} {\langle} incoming {\rangle}}%
\@pvspace{8.0pt}%
\@x{ RDo \.{\defeq} {\UNCHANGED} Rvars}%
\@x{}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 20:28:26 \ensuremath{CST} 2019 by \ensuremath{xhdn
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Last modified \ensuremath{Mon} May 06
 15:22:12 \ensuremath{CST} 2019 by \ensuremath{jywellin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Wed} \ensuremath{Mar} 27
 16:45:34 \ensuremath{CST} 2019 by \ensuremath{jywellin
}%
\end{cpar}%
\end{lcom}%
\end{document}
