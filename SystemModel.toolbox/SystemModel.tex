...
\@x{ {\CONSTANTS}}%
\@x{\@s{16.4} Replica ,\,\@s{4.1}}%
\@y{\@s{0}%
 the set of replicas
}%
\@xx{}%
\@x{\@s{16.4} Msg\@s{23.75}}%
\@y{\@s{0}%
 the set of messages
}%
\@xx{}%
...
\@xx{}%
\@x{}\midbar\@xx{}%
\@x{ SMTypeOK \.{\defeq}\@s{4.1}}%
\@y{\@s{0}%
 each incoming channel is a set of messages
}%
\@xx{}%
\@x{\@s{16.4} incoming \.{\in} [ Replica \.{\rightarrow} {\SUBSET} Msg ]}%
\@x{}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
...
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Last modified Sun \ensuremath{Jun} 16
 20:52:51 \ensuremath{CST} 2019 by \ensuremath{xhdn
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Wed} \ensuremath{Jun} 05
 21:05:12 \ensuremath{CST} 2019 by \ensuremath{xhdn
}%
\end{cpar}%
\end{lcom}%
\end{document}
