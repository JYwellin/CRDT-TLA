...
\@x{}\moduleLeftDash\@xx{ {\MODULE} OptimizedAWSet}\moduleRightDash\@xx{}%
...
\@x{\@s{16.4} \.{\land}\@s{9.74} seq \.{\in} [ Replica \.{\rightarrow} Nat ]}%
 \@x{\@s{16.4} \.{\land}\@s{9.74} vc \.{\in} [ Replica \.{\rightarrow} Vector
 ]}%
\@x{}\midbar\@xx{}%
\@x{ Init \.{\defeq}}%
...
\@x{\@s{16.4} \.{\land} seq \.{=} [ r \.{\in} Replica \.{\mapsto} 0 ]}%
 \@x{\@s{16.4} \.{\land} vc \.{=} [ r \.{\in} Replica \.{\mapsto} Initvector
 ]}%
\@x{}\midbar\@xx{}%
\@x{ Add ( d ,\, r ) \.{\defeq}}%
...
\@x{\@s{22.06} \.{\land} SECUpdate ( r ,\, seq [ r ] )}%
 \@x{\@s{22.06} \.{\land} \.{\LET} D \.{\defeq} \{ ins \.{\in} aSet [ r ]
 \.{:} ins . d \.{=} d \.{\land} ins . r \.{=} r \}}%
 \@x{\@s{33.17} \.{\IN} aSet \.{'} \.{=} [ aSet {\EXCEPT} {\bang} [ r ] \.{=}
 ( @ \.{\cup} \{ [ d \.{\mapsto} d ,\, r \.{\mapsto} r ,\, k \.{\mapsto} vc [
 r ] [ r ] \.{+} 1 ] \} ) \.{\,\backslash\,} D ]}%
 \@x{\@s{22.06} \.{\land} vc \.{'} \.{=} [ vc {\EXCEPT} {\bang} [ r ] [ r ]
 \.{=} @ \.{+} 1 ]}%
 \@x{\@s{22.06} \.{\land} {\UNCHANGED} {\langle} incoming ,\, msg ,\,
 messageset {\rangle}}%
\@pvspace{8.0pt}%
\@x{ Remove ( d ,\, r ) \.{\defeq}}%
...
\@x{\@s{16.4} \.{\land} SECUpdate ( r ,\, seq [ r ] )}%
 ...
 ins . d \.{=} d \}}%
 \@x{\@s{27.51} \.{\IN}\@s{8.2} aSet \.{'} \.{=} [ aSet {\EXCEPT} {\bang} [ r
 ] \.{=} @ \.{\,\backslash\,} D ]}%
 \@x{\@s{16.4} \.{\land} {\UNCHANGED} {\langle} vc ,\, incoming ,\, msg ,\,
 messageset {\rangle}}%
\@x{}\midbar\@xx{}%
\@x{ Send ( r ) \.{\defeq}}%
 \@x{\@s{21.98} \.{\land} Network {\bang} NBroadcast ( r ,\, [ r \.{\mapsto} r
 ,\, seq \.{\mapsto} seq [ r ] ,\, update \.{\mapsto} StateUpdate ( r ) ,\,
 vc \.{\mapsto} vc [ r ] ,\, A \.{\mapsto} aSet [ r ] ] )}%
\@x{\@s{21.98} \.{\land} SECSend ( r )}%
 \@x{\@s{21.98} \.{\land} {\UNCHANGED} {\langle} aSet ,\, seq ,\, vc
 {\rangle}}%
\@pvspace{8.0pt}%
\@x{ SetMax ( r ,\, s ) \.{\defeq} {\IF} r \.{>} s \.{\THEN} r \.{\ELSE} s}%
\@pvspace{8.0pt}%
\@x{ Deliver ( r ) \.{\defeq}}%
...
\@x{\@s{16.4} \.{\land}\@s{4.75} SECDeliver ( r ,\, msg [ r ] \.{'} )}%
 ...
 \@x{\@s{16.4} \.{\land}\@s{4.75} \.{\LET} Diff1 \.{\defeq} \{ ins \.{\in}
 aSet [ r ]\@s{11.16} \.{:} {\lnot} ins \.{\in} msg [ r ] \.{'} . A \}}%
 \@x{\@s{52.66} Diff2 \.{\defeq} \{ ins \.{\in} msg [ r ] \.{'} . A \.{:}
 {\lnot} ins \.{\in} aSet [ r ]\@s{4.1} \}}%
 \@x{\@s{52.66} D1 \.{\defeq} \{ ins \.{\in} Diff1 \.{:} ins . k \.{\leq} msg
 [ r ] \.{'} . vc [ ins . r ] \}}%
 \@x{\@s{52.66} D2 \.{\defeq} \{ ins \.{\in} Diff2 \.{:} ins . k \.{\leq} vc [
 r ] [ ins . r ] \}}%
\@x{\@s{52.66} Alocal \.{\defeq} aSet [ r ] \.{\,\backslash\,} D1}%
\@x{\@s{56.76} Aremote \.{\defeq} msg [ r ] \.{'} . A \.{\,\backslash\,} D2}%
 \@x{\@s{32.26} \.{\IN}\@s{4.09} aSet \.{'} \.{=} [ aSet {\EXCEPT} {\bang} [ r
 ] \.{=} Alocal \.{\cup} Aremote ]}%
 \@x{\@s{16.4} \.{\land}\@s{4.75} \A\, s \.{\in} Replica \.{:} vc \.{'} \.{=}
 [ vc {\EXCEPT} {\bang} [ r ] [ s ] \.{=} SetMax ( @ ,\, msg \.{'} [ r ] . vc
 [ s ] ) ]}%
\@x{\@s{16.4} \.{\land}\@s{4.75} {\UNCHANGED} {\langle} vc {\rangle}}%
\@x{}\midbar\@xx{}%
\@x{ Next \.{\defeq}}%
...
\@pvspace{8.0pt}%
 ...
 r2 )}%
\@x{\@s{57.41} \.{\implies} Read ( r1 ) \.{=} Read ( r2 )}%
\@x{}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 01:14:37 \ensuremath{CST} 2019 by \ensuremath{xhdn
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Last modified \ensuremath{Mon} May 06
 15:58:14 \ensuremath{CST} 2019 by \ensuremath{jywellin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created Sun \ensuremath{Apr} 28 13:52:27
