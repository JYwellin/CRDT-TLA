...
\@x{}\midbar\@xx{}%
\@x{ SECInit \.{\defeq}}%
 \@x{\@s{16.4} \.{\land} uset \.{=} [ r\@s{5.87} \.{\in} Replica \.{\mapsto}
 \{ \} ]}%
 \@x{\@s{16.4} \.{\land} uincoming \.{=} [ r \.{\in} Replica \.{\mapsto} \{ \}
 ]}%
\@pvspace{8.0pt}%
\@x{ SECDo ( r ) \.{\defeq}}%
 \@x{\@s{16.4} \.{\land} uset \.{'} \.{=} [ uset {\EXCEPT} {\bang} [ r ] \.{=}
 @ \.{\cup} \{ [ r \.{\mapsto} r ,\, seq \.{\mapsto} seq [ r ] ] \} ]}%
\@x{\@s{16.4} \.{\land} {\UNCHANGED} {\langle} uincoming {\rangle}}%
\@pvspace{8.0pt}%
 \@x{ SECSend ( r ) \.{\defeq}\@s{4.1} {\UNCHANGED} {\langle} uset
 {\rangle}\@s{4.1}}%
\@y{\@s{0}%
...
\@y{\@s{0}%
 choose the \ensuremath{SEC} message \ensuremath{um} according to aid
}%
\@xx{}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Jun} 26 13:23:02 \ensuremath{CST} 2019 by \ensuremath{xhdn
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
