...
\@x{}\moduleLeftDash\@xx{ {\MODULE} CausalInterface}\moduleRightDash\@xx{}%
\@x{ {\EXTENDS} SEC}%
\@x{}\midbar\@xx{}%
\@x{ {\CONSTANTS}}%
...
\@x{}%
\@y{\@s{0}%
 Op-based \ensuremath{AWSet} definition
}%
\@xx{}%
 \@x{ Instance \.{\defeq} [ d \.{:} Data ,\, r \.{:} Replica ,\, k \.{:} Nat
 ]}%
 \@x{ Msg \.{\defeq} [ r \.{:} Replica ,\, update \.{:} {\SUBSET} Uid ,\, seq
 \.{:} Nat ,\, vc \.{:} Vector ,\, abuf \.{:} {\SUBSET} Instance ,\, rbuf
 \.{:} {\SUBSET} Instance ]}%
\@x{}\midbar\@xx{}%
\@x{ {\VARIABLES}}%
\@x{\@s{16.4}}%
...
\@xx{}%
\@pvspace{8.0pt}%
 \@x{ NETvars \.{\defeq} {\langle} incoming ,\, msg ,\, messageset ,\, vc ,\,
 seq {\rangle}}%
\@x{}\midbar\@xx{}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
Reliable Causal \ensuremath{Network
}%
\end{cpar}%
\end{lcom}%
\@x{ RNetwork \.{\defeq} {\INSTANCE} ReliableCausalNetwork}%
\@x{}\midbar\@xx{}%
\@x{ IntTypeOK \.{\defeq}}%
\@x{\@s{20.5} seq \.{\in} [ Replica \.{\rightarrow}\@s{4.1} Nat ]}%
\@pvspace{8.0pt}%
\@x{ IntInit \.{\defeq}}%
\@x{\@s{16.4} \.{\land} seq \.{=} [ r \.{\in} Replica \.{\mapsto} 0 ]}%
\@x{\@s{16.4} \.{\land} RNetwork {\bang} RCInit}%
\@x{\@s{16.4} \.{\land} SECInit}%
\@pvspace{8.0pt}%
\@x{ IntSend ( r ,\, m ) \.{\defeq}}%
\@x{\@s{16.4} \.{\land}\@s{7.27} RNetwork {\bang} RCBroadcast ( r ,\, m )}%
\@x{\@s{16.4} \.{\land}\@s{7.27} SECSend ( r )}%
\@x{\@s{16.4} \.{\land}\@s{7.27} {\UNCHANGED} {\langle} seq {\rangle}}%
\@pvspace{8.0pt}%
\@x{ IntReceive ( r ) \.{\defeq}}%
\@x{\@s{16.4} \.{\land} RNetwork {\bang} RCDeliver ( r )}%
\@x{\@s{16.4} \.{\land} SECDeliver ( r ,\, msg \.{'} )}%
\@x{\@s{16.4} \.{\land} {\UNCHANGED} {\langle} seq {\rangle}}%
\@pvspace{8.0pt}%
\@x{ IntDo ( r ) \.{\defeq}}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Jun} 04 01:12:22 \ensuremath{CST} 2019 by \ensuremath{xhdn
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Mon} \ensuremath{Jun} 03
 21:20:23 \ensuremath{CST} 2019 by \ensuremath{xhdn
}%
\end{cpar}%
\end{lcom}%
\end{document}
