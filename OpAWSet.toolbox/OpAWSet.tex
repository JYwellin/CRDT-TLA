...
\@x{}%
\@y{\@s{0}%
 variables for \ensuremath{SEC}:
}%
\@xx{}%
\@x{\@s{16.4} uset ,\,\@s{31.38}}%
\@y{\@s{0}%
 \ensuremath{uset[r]}: the set of updates seen by replica \ensuremath{r
 \.{\in} Replica
}}%
\@xx{}%
...
\@x{ secVars \.{\defeq} {\langle} uset ,\, uincoming ,\, buset {\rangle}}%
 \@x{ vars \.{\defeq} {\langle} aset ,\, abuf ,\, rbuf ,\, seq ,\, nVars ,\,
 secVars {\rangle}}%
\@x{}\midbar\@xx{}%
 \@x{ Msg \.{\defeq} [ aid \.{:} Aid ,\, abuf \.{:} {\SUBSET} Element ,\, rbuf
 \.{:} {\SUBSET} Element ,\, lvc \.{:} [ Replica \.{\rightarrow} Nat ] ]}%
...
\@xx{}%
\@x{ SEC \.{\defeq} {\INSTANCE} OpSEC}%
\@y{\@s{0}%
 \ensuremath{{\WITH}} \ensuremath{uset \.{\leftarrow} uset},
 \ensuremath{uincoming \.{\leftarrow} uincoming}, \ensuremath{buset
 \.{\leftarrow} buset
}}%
\@xx{}%
\@x{}\midbar\@xx{}%
...
\@x{\@s{16.4} \.{\land} Network {\bang} SMTypeOK}%
\@x{\@s{16.4} \.{\land} SEC {\bang} SECTypeOK}%
\@x{}\midbar\@xx{}%
\@x{ Init \.{\defeq}}%
...
\@x{\@s{16.4} \.{\land} SEC {\bang} OpSECInit}%
\begin{lcom}{0}%
...
\@x{\@s{22.06} \.{\land} SEC {\bang} OpSECDo ( r )}%
...
\@x{\@s{16.4} \.{\land} SEC {\bang} OpSECDo ( r )}%
...
\@xx{}%
\@x{\@s{21.98} \.{\land} \.{\lor} abuf [ r ] \.{\neq} \{ \}}%
\@x{\@s{33.09} \.{\lor} rbuf [ r ]\@s{0.89} \.{\neq} \{ \}}%
...
\@x{\@s{21.98} \.{\land} SEC {\bang} OpSECSend ( r )}%
...
\@x{\@s{16.4} \.{\land} Network {\bang} RCNDeliver ( r )}%
 \@x{\@s{16.4} \.{\land} SEC {\bang} OpSECDeliver ( r ,\, lmsg \.{'} [ r ] .
 aid )}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Jun} 26 13:30:44 \ensuremath{CST} 2019 by \ensuremath{xhdn
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
