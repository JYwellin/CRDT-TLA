...
\@x{}\midbar\@xx{}%
\@x{ {\VARIABLES}}%
\@x{\@s{16.4} set ,\,\@s{27.80}}%
\@y{\@s{0}%
 \ensuremath{set[r]}: set of \ensuremath{Element(s)} maintained by
 \ensuremath{r \.{\in} Replica
}}%
\@xx{}%
\@x{\@s{16.4} abuf ,\,\@s{20.50}}%
\@y{\@s{0}%
 \ensuremath{abuf[r]}: buffer of \ensuremath{Element(s)} added maintained by
 \ensuremath{r \.{\in} Replica
}}%
\@xx{}%
\@x{\@s{16.4} rbuf ,\,\@s{21.39}}%
\@y{\@s{0}%
 \ensuremath{rbuf[r]}: buffer of \ensuremath{Element(s)} removed maintained
 by \ensuremath{r \.{\in} Replica
}}%
\@xx{}%
\@pvspace{8.0pt}%
\begin{lcom}{10.0}%
...
\begin{lcom}{10.0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
\ensuremath{SEC} variables
\end{cpar}%
\end{lcom}%
\@x{\@s{16.4} updateset ,\,}%
\@x{\@s{16.4} uincoming ,\,}%
\@x{\@s{16.4} new\_updateset}%
\@pvspace{8.0pt}%
\@x{ Nvars \.{\defeq} {\langle} incoming ,\, lmsg ,\, dmsg ,\, vc {\rangle}}%
 \@x{ SECvars \.{\defeq} {\langle} updateset ,\, new\_updateset ,\, uincoming
 {\rangle}}%
 \@x{ vars \.{\defeq} {\langle} set ,\, abuf ,\, rbuf ,\, seq ,\, Nvars ,\,
 SECvars {\rangle}}%
\@x{}\midbar\@xx{}%
 \@x{ Msg \.{\defeq} [ r \.{:} Replica ,\, seq \.{:} Nat ,\, vc \.{:} Vector
 ,\, abuf \.{:} {\SUBSET} Element ,\, rbuf \.{:} {\SUBSET} Element ]}%
\@y{%
 message type
}%
\@xx{}%
...
\@xx{}%
\@x{ Read ( r ,\, s ) \.{\defeq} \{ ele . d \.{:} ele \.{\in} s \}}%
\@x{}%
\@y{\@s{0}%
 instantiate \ensuremath{SEC} module
}%
\@xx{}%
\@x{ SEC \.{\defeq} {\INSTANCE} OpSEC {\WITH} data \.{\leftarrow} set}%
\@x{}\midbar\@xx{}%
...
\@xx{}%
 \@x{\@s{16.4} \.{\land}\@s{9.74} set \.{\in} [ Replica \.{\rightarrow}
 {\SUBSET} Element ]}%
 \@x{\@s{16.4} \.{\land}\@s{9.74} abuf \.{\in} [ Replica \.{\rightarrow}
 {\SUBSET} Element ]}%
 \@x{\@s{16.4} \.{\land}\@s{9.74} rbuf\@s{0.89} \.{\in} [ Replica
 \.{\rightarrow} {\SUBSET} Element ]}%
\@x{\@s{16.4} \.{\land}\@s{9.74} IntTypeOK}%
\@x{\@s{16.4} \.{\land}\@s{9.74} Network {\bang} SMTypeOK}%
\@x{\@s{16.4} \.{\land}\@s{9.74} SEC {\bang} SECTypeOK}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
1
\end{cpar}%
...
\@xx{}%
 ...
 r ]\@s{0.89} \.{=} \{ \} ]}%
 \@x{\@s{21.98} \.{\land} Network {\bang} RCBroadcast ( r ,\, [ r \.{\mapsto}
 r ,\, seq \.{\mapsto} seq [ r ] ,\, vc \.{\mapsto} [ vc {\EXCEPT} {\bang} [
 r ] [ r ] \.{=} @ \.{+} 1 ] [ r ] ,\,}%
 \@x{\@s{270.25} abuf \.{\mapsto} abuf [ r ] ,\, rbuf \.{\mapsto} rbuf [ r ] ]
 )}%
\@x{\@s{21.98} \.{\land} SEC {\bang} OpSECSend ( r ,\, seq [ r ] )}%
\@x{\@s{21.98} \.{\land} IntSend ( r )}%
\@x{\@s{21.98} \.{\land} {\UNCHANGED} {\langle} set {\rangle}}%
\@pvspace{8.0pt}%
\@x{ Deliver ( r ) \.{\defeq}\@s{4.1}}%
\@y{\@s{0}%
 \ensuremath{r\.{\in} Replica} receives a message
}%
\@xx{}%
\@x{\@s{16.4} \.{\land}\@s{4.75} Network {\bang} RCDeliver ( r )}%
 \@x{\@s{16.4} \.{\land}\@s{4.75} SEC {\bang} OpSECDeliver ( r ,\, [ r
 \.{\mapsto} lmsg \.{'} . r ,\, seq \.{\mapsto} lmsg \.{'} . seq ] )}%
 \@x{\@s{16.4} \.{\land}\@s{4.75} set \.{'} \.{=} [ set {\EXCEPT} {\bang} [ r
 ] \.{=} ( @ \.{\cup} lmsg \.{'} . abuf ) \.{\,\backslash\,} lmsg \.{'} .
 rbuf ]}%
\@x{\@s{16.4} \.{\land}\@s{4.75} IntDeliver ( r )}%
 \@x{\@s{16.4} \.{\land}\@s{4.75} {\UNCHANGED} {\langle} abuf ,\, rbuf
 {\rangle}}%
\@x{}\midbar\@xx{}%
\@x{ Add ( d ,\, r ) \.{\defeq}\@s{16.4}}%
\@y{\@s{0}%
 \ensuremath{r\.{\in} Replica} adds \ensuremath{d \.{\in} Data
}}%
\@xx{}%
 \@x{\@s{22.06} \.{\land} set \.{'}\@s{7.30} \.{=} [ set {\EXCEPT} {\bang} [ r
 ] \.{=} @ \.{\cup} \{ [ d \.{\mapsto} d ,\, r \.{\mapsto} r ,\, k
 \.{\mapsto} seq [ r ] ] \} ]}%
 \@x{\@s{22.06} \.{\land} abuf \.{'} \.{=} [ abuf {\EXCEPT} {\bang} [ r ]
 \.{=} @ \.{\cup} \{ [ d \.{\mapsto} d ,\, r \.{\mapsto} r ,\, k \.{\mapsto}
 seq [ r ] ] \} ]}%
\@x{\@s{22.06} \.{\land} IntDo ( r )}%
\@x{\@s{22.06} \.{\land} Network {\bang} RCDo}%
\@x{\@s{22.06} \.{\land} SEC {\bang} OpSECUpdate ( r ,\, seq [ r ] )}%
\@x{\@s{22.06} \.{\land} {\UNCHANGED} {\langle} rbuf {\rangle}}%
\@pvspace{8.0pt}%
...
\@xx{}%
 \@x{\@s{16.4} \.{\land} \{ ele \.{\in} set [ r ] \.{:} ele . d \.{=} d \}
 \.{\neq} \{ \}}%
 \@x{\@s{16.4} \.{\land} \.{\LET} D \.{\defeq} \{ ele \.{\in} set [ r ] \.{:}
 ele . d \.{=} d \}}%
 \@x{\@s{27.51} \.{\IN} \.{\land}\@s{4.1} set \.{'} \.{=} [ set {\EXCEPT}
 {\bang} [ r ] \.{=} @ \.{\,\backslash\,} D ]}%
 \@x{\@s{47.91} \.{\land}\@s{4.10} rbuf \.{'} \.{=} [ rbuf {\EXCEPT} {\bang} [
 r ] \.{=} @ \.{\cup} D ]}%
\@x{\@s{16.4} \.{\land} IntDo ( r )}%
\@x{\@s{16.4} \.{\land} Network {\bang} RCDo}%
\@x{\@s{16.4} \.{\land} SEC {\bang} OpSECUpdate ( r ,\, seq [ r ] )}%
\@x{\@s{16.4} \.{\land} {\UNCHANGED} {\langle} abuf {\rangle}}%
\@pvspace{8.0pt}%
\@x{ Do ( r ) \.{\defeq}\@s{32.8}}%
\@y{\@s{0}%
 update operations
...
\@xx{}%
\@x{\@s{16.4} \E\, r \.{\in} Replica \.{:}}%
\@x{\@s{27.72} Deliver ( r ) \.{\lor} Send ( r ) \.{\lor} Do ( r )}%
\@pvspace{8.0pt}%
...
\@x{}%
\@y{%
 \ensuremath{SECa \.{\defeq} \A\, r1}, \ensuremath{r2 \.{\in} Replica} :
}%
\@xx{}%
\@x{}%
\@y{\@s{27.5}%
 \ensuremath{SEC{\bang}Sameupdate(r1,\, r2) \.{\implies} Read(r1) \.{=}
 Read(r2)
}}%
\@xx{}%
\@x{}\bottombar\@xx{}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Jun} 13 21:46:27 \ensuremath{CST} 2019 by \ensuremath{xhdn
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
