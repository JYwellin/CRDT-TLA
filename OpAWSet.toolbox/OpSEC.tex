...
\@x{}\moduleLeftDash\@xx{ {\MODULE} OpSEC}\moduleRightDash\@xx{}%
\@x{ {\EXTENDS} SEC}%
\@x{}\midbar\@xx{}%
...
\@pvspace{8.0pt}%
\@x{ OpSECSend ( r ) \.{\defeq}}%
\@x{\@s{16.4} \.{\land} SECSend ( r )}%
 \@x{\@s{16.4} \.{\land} uincoming \.{'} \.{=} [ x \.{\in} Replica
 \.{\mapsto}\@s{16.4}}%
\@y{\@s{0}%
 broadcast \ensuremath{buset[r]
}}%
\@xx{}%
\@x{\@s{60.31} {\IF} x \.{=} r \.{\THEN} uincoming [ x ]}%
 \@x{\@s{96.93} \.{\ELSE} uincoming [ x ] \.{\cup} \{ [ aid \.{\mapsto} [ r
...
\@xx{}%
\@pvspace{8.0pt}%
\@x{ OpSECDeliver ( r ,\, aid ) \.{\defeq}}%
\@x{\@s{16.4} \.{\land}\@s{4.1} SECDeliver ( r ,\, aid )}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Jun} 26 13:21:02 \ensuremath{CST} 2019 by \ensuremath{xhdn
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Tue} \ensuremath{Jun} 11
 17:32:49 \ensuremath{CST} 2019 by \ensuremath{xhdn
}%
\end{cpar}%
\end{lcom}%
\end{document}
