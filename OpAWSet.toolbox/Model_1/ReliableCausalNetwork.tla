...
RCNCausallyReady(r, cm) ==  \* whether m is causally ready to be delivered by r \in Replica
    LET mr == sender(cm) 
...
RCNDeliver(r) == 
    ...
    /\ \E cm \in incoming[r]: 
         ...
         /\ incoming' = [incoming EXCEPT ![r] = @ \ {cm}]   \* delete m 
=============================================================================
\* Modification History
\* Last modified Tue Jun 25 22:44:30 CST 2019 by xhdn
