...
\@xx{}%
\@x{}\midbar\@xx{}%
\@x{ Network \.{\defeq} {\INSTANCE} BasicNetwork\@s{16.4}}%
\@y{\@s{0}%
 instance a basic network
}%
\@xx{}%
\@x{}\midbar\@xx{}%
\@x{ TypeOK \.{\defeq}}%
...
\@xx{}%
 \@x{\@s{22.06} aset \.{'} \.{=} [ aset {\EXCEPT} {\bang} [ r ] \.{=} @
 \.{\cup} \{ [ d \.{\mapsto} d ,\, r \.{\mapsto} r ,\, k \.{\mapsto} seq [ r
 ] ] \} ]}%
\@pvspace{8.0pt}%
\@x{ Remove ( d ,\, r )\@s{6.94} \.{\defeq}}%
\@y{\@s{0}%
 \ensuremath{r\.{\in} Replica} remove \ensuremath{d \.{\in} Data
}}%
\@xx{}%
 \@x{\@s{38.51} \.{\LET} E \.{\defeq} \{ ele \.{\in} aset [ r ] \.{:} ele . d
 \.{=} d \}}%
 \@x{\@s{38.51} \.{\IN} \.{\land} aset \.{'} \.{=} [ aset {\EXCEPT} {\bang} [
 r ] \.{=} @ \.{\,\backslash\,} E ]}%
 \@x{\@s{58.91} \.{\land} tset \.{'}\@s{1.78} \.{=} [ tset {\EXCEPT} {\bang} [
 r ]\@s{1.78} \.{=} @ \.{\cup} E ]}%
\@pvspace{8.0pt}%
\@x{ Read ( r ) \.{\defeq}}%
\@y{\@s{0}%
...
\@xx{}%
 \@x{\@s{21.98} Network {\bang} NBroadcast ( r ,\,\@s{4.1} [ r \.{\mapsto} r
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Jun} 10 02:28:39 \ensuremath{CST} 2019 by \ensuremath{xhdn
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created Sun \ensuremath{Jun} 09 18:27:03
