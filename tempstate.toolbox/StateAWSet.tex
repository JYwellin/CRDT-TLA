...
\@x{ {\EXTENDS} Naturals ,\, Sequences ,\, Interface}%
\@x{}\midbar\@xx{}%
\@x{ {\CONSTANTS}}%
...
\@x{ Nvars\@s{4.1} \.{\defeq} {\langle} incoming ,\, lmsg {\rangle}}%
 ...
 {\rangle}}%
\@x{}\midbar\@xx{}%
 \@x{ Element \.{\defeq} [ d \.{:} Data ,\, r \.{:} Replica ,\, k \.{:} Nat
 ]\@s{12.29}}%
\@y{\@s{0}%
 所有可能元素的集合
}%
\@xx{}%
 ...
 {\SUBSET} Uid ,\, A \.{:} {\SUBSET} Element ,\, T \.{:} {\SUBSET} Element ]}%
\@x{}\midbar\@xx{}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
Any \ensuremath{Network
}%
\end{cpar}%
\end{lcom}%
\@x{ Network \.{\defeq} {\INSTANCE} BasicNetwork}%
\@x{}\midbar\@xx{}%
\@x{ TypeOK \.{\defeq}}%
...
\@x{}\midbar\@xx{}%
\@x{ Send ( r ) \.{\defeq}\@s{20.5}}%
\@y{\@s{0}%
 \ensuremath{r\.{\in} Replica} send a message
}%
\@xx{}%
 \@x{\@s{21.98} \.{\land} Network {\bang} NBroadcast ( r ,\,\@s{4.1} [ r
 \.{\mapsto} r ,\, seq \.{\mapsto} seq [ r ] ,\, update \.{\mapsto}
 StateUpdate ( r ) ,\, A \.{\mapsto} aset [ r ] ,\, T \.{\mapsto} tset [ r ]
 ] )}%
 \@x{\@s{21.98} \.{\land} IntSend ( r ,\, [ r \.{\mapsto} r ,\, seq
 \.{\mapsto} seq [ r ] ,\, update \.{\mapsto} StateUpdate ( r ) ,\, A
 \.{\mapsto} aset [ r ] ,\, T \.{\mapsto} tset [ r ] ] )}%
\@x{\@s{21.98} \.{\land} {\UNCHANGED} {\langle} aset ,\, tset {\rangle}}%
\@pvspace{8.0pt}%
\@x{ Receive ( r ) \.{\defeq}\@s{20.5}}%
\@y{\@s{0}%
 \ensuremath{r\.{\in} Replica} receive a message
}%
\@xx{}%
\@x{\@s{16.4} \.{\land}\@s{5.06} Network {\bang} NDeliver ( r )}%
\@x{\@s{16.4} \.{\land}\@s{5.06} IntReceive ( r ,\, lmsg \.{'} )}%
...
\@y{\@s{0}%
 \ensuremath{r\.{\in} Replica} add \ensuremath{d \.{\in} Data
}}%
\@xx{}%
...
\@x{ Remove ( d ,\, r ) \.{\defeq}}%
\@y{\@s{0}%
 \ensuremath{r\.{\in} Replica} remove \ensuremath{d \.{\in} Data
}}%
\@xx{}%
...
\@x{}\midbar\@xx{}%
\@x{ Next \.{\defeq}}%
 \@x{\@s{16.4} \E\, r \.{\in} Replica \.{:} Receive ( r ) \.{\lor} Send ( r )
 \.{\lor} Do ( r )}%
\@pvspace{8.0pt}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 22:57:52 \ensuremath{CST} 2019 by \ensuremath{xhdn
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
