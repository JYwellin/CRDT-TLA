...
\@x{ SEC \.{\defeq} \A\, r1 ,\, r2 \.{\in} Replica \.{:}}%
 \@x{\@s{44.00} Sameupdate ( r1 ,\, r2 ) \.{\implies} Read ( r1 ) \.{=} Read (
 r2 )}%
\@x{}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
...
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Last modified \ensuremath{Tue} May 14
 11:24:42 \ensuremath{CST} 2019 by \ensuremath{zfwang
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
