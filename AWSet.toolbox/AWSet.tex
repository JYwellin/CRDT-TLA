...
\@x{ {\EXTENDS} CRDTInterface}%
\@x{}\midbar\@xx{}%
\@x{ {\CONSTANTS} Data\@s{73.79}}%
\@y{\@s{0}%
 the set of data
}%
\@xx{}%
\@x{ Element \.{\defeq} [ aid \.{:} Aid ,\, d \.{:} Data ]\@s{7.86}}%
\@y{\@s{0}%
 the set of elements
}%
\@xx{}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Jun} 25 20:07:27 \ensuremath{CST} 2019 by \ensuremath{xhdn
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Wed} \ensuremath{Jun} 12
 17:15:47 \ensuremath{CST} 2019 by \ensuremath{xhdn
}%
\end{cpar}%
\end{lcom}%
\end{document}
