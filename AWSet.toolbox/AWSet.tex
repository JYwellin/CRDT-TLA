...
\@x{}\midbar\@xx{}%
 ...
 \@x{ Msg \.{\defeq} [ r \.{:} Replica ,\, seq \.{:} Nat ,\, update \.{:}
 {\SUBSET} Update ,\, A \.{:} {\SUBSET} Instance ,\, T \.{:} {\SUBSET}
 Instance ]}%
\@x{}\midbar\@xx{}%
...
\@x{}\midbar\@xx{}%
\@x{ Add ( d ,\, r ) \.{\defeq}}%
 \@x{\@s{22.06} \.{\land} seq \.{'} \.{=} [ seq {\EXCEPT} {\bang} [ r ] \.{=}
 @ \.{+} 1 ]}%
...
\@x{\@s{16.4} \.{\land} SECUpdate ( r ,\, seq [ r ] )}%
 \@x{\@s{16.4} \.{\land} \.{\LET} D \.{\defeq} \{ ins \.{\in} aSet [ r ] \.{:}
 ins . d \.{=} d \}}%
...
\@x{ Send ( r ) \.{\defeq}}%
 ...
 ,\, seq \.{\mapsto} seq [ r ] ,\, update \.{\mapsto} StateUpdate ( r ) ,\, A
 \.{\mapsto} aSet [ r ] ,\, T \.{\mapsto} tSet [ r ] ] )}%
\@x{\@s{21.98} \.{\land} SECSend ( r )}%
 \@x{\@s{21.98} \.{\land} {\UNCHANGED} {\langle} aSet ,\, tSet ,\, seq
 {\rangle}}%
\@pvspace{8.0pt}%
\@x{ Deliver ( r ) \.{\defeq}}%
\@x{\@s{16.4} \.{\land}\@s{4.75} Network {\bang} NDeliver ( r )}%
\@x{\@s{16.4} \.{\land}\@s{4.75} SECDeliver ( r ,\, msg \.{'} [ r ] )}%
 \@x{\@s{16.4} \.{\land}\@s{4.75} seq \.{'} \.{=} [ seq {\EXCEPT} {\bang} [ r
 ] \.{=} @ \.{+} 1 ]}%
...
\@x{\@s{31.61} Send ( r ) \.{\lor} Deliver ( r )}%
\@pvspace{8.0pt}%
...
\@xx{}%
\@x{ Quiescence \.{\defeq}}%
 \@x{\@s{16.4} \A\, r \.{\in} Replica \.{:} incoming [ r ] \.{=} {\langle}
 {\rangle}}%
\@pvspace{8.0pt}%
\@x{ Convergence \.{\defeq}}%
\@x{\@s{16.4} \A\, r ,\, s \.{\in} Replica \.{:} Read ( r ) \.{=} Read ( s )}%
\@pvspace{8.0pt}%
...
\@xx{}%
\@x{ SEC \.{\defeq} \A\, r1 ,\, r2 \.{\in} Replica \.{:}}%
\@x{\@s{44.00} Sameupdate ( r1 ,\, r2 ) \.{\implies} Convergence}%
\@x{}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 20:55:42 \ensuremath{CST} 2019 by \ensuremath{xhdn
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Last modified \ensuremath{Mon} May 13
 13:28:35 \ensuremath{CST} 2019 by \ensuremath{zfwang
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
