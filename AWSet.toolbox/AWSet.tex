...
\@x{}\moduleLeftDash\@xx{ {\MODULE} AWSet}\moduleRightDash\@xx{}%
\@x{ {\EXTENDS} Naturals ,\, Sequences ,\, SEC}%
\@x{}\midbar\@xx{}%
\@x{ {\CONSTANTS}}%
\@x{\@s{16.4} Data\@s{24.48}}%
\@y{\@s{0}%
 the set of data
}%
\@xx{}%
\@pvspace{8.0pt}%
\@x{ {\VARIABLES}}%
\@x{\@s{16.4} aSet ,\,\@s{20.63}}%
\@y{\@s{0}%
 \ensuremath{aSet[r]}: set of active \ensuremath{Instance(s)} maintained by
 \ensuremath{r \.{\in} Replica
}}%
\@xx{}%
\@x{\@s{16.4} tSet ,\,\@s{22.42}}%
\@y{\@s{0}%
 \ensuremath{tSet[r]}: set of tombstone \ensuremath{Instance(s)} maintained
 by \ensuremath{r \.{\in} Replica
}}%
\@xx{}%
\@x{\@s{16.4} seq ,\,\@s{26.57}}%
\@y{\@s{0}%
 \ensuremath{seq[r]}: local sequence number at replica \ensuremath{r \.{\in}
 Replica
}}%
\@xx{}%
\@x{\@s{16.4} incoming ,\,}%
\@y{\@s{0}%
 \ensuremath{incoming[r]}: incoming messages at replica \ensuremath{r \.{\in}
 Replica
}}%
\@xx{}%
\@x{\@s{16.4} msg ,\,}%
\@x{\@s{16.4} messageSet}%
\@pvspace{8.0pt}%
 \@x{ vars \.{\defeq} {\langle} aSet ,\, tSet ,\, seq ,\, incoming ,\, msg ,\,
 messageSet ,\, SECvars {\rangle}}%
\@x{}\midbar\@xx{}%
 \@x{ Instance \.{\defeq} [ d \.{:} Data ,\, r \.{:} Replica ,\, k \.{:} Nat
 ]}%
 \@x{ Msg \.{\defeq} [ r \.{:} Replica ,\, A \.{:} {\SUBSET} Instance ,\, T
 \.{:} {\SUBSET} Instance ,\, seq \.{:} Nat ,\,}%
\@x{\@s{37.42} update \.{:} {\SUBSET} Update ]}%
\@x{}\midbar\@xx{}%
\@x{ Network \.{\defeq} {\INSTANCE} Network}%
\@x{}\midbar\@xx{}%
\@x{ TypeOK \.{\defeq}}%
 \@x{\@s{16.4} \.{\land}\@s{9.74} aSet \.{\in} [ Replica \.{\rightarrow}
 {\SUBSET} Instance ]}%
 \@x{\@s{16.4} \.{\land}\@s{9.74} tSet\@s{1.78} \.{\in} [ Replica
 \.{\rightarrow} {\SUBSET} Instance ]}%
\@x{\@s{16.4} \.{\land}\@s{9.74} seq \.{\in} [ Replica \.{\rightarrow} Nat ]}%
\@x{}\midbar\@xx{}%
\@x{ Init \.{\defeq}}%
...
\@x{\@s{16.4} \.{\land} Network {\bang} NInit}%
\@x{\@s{16.4} \.{\land} SECInit}%
\@x{}\midbar\@xx{}%
\@x{ Add ( d ,\, r ) \.{\defeq}}%
 \@x{\@s{22.06} \.{\land} seq \.{'}\@s{5.94} \.{=} [ seq {\EXCEPT} {\bang} [ r
 ] \.{=} @ \.{+} 1 ]}%
 \@x{\@s{22.06} \.{\land} aSet \.{'} \.{=} [ aSet {\EXCEPT} {\bang} [ r ]
 \.{=} @ \.{\cup} \{ [ d \.{\mapsto} d ,\, r \.{\mapsto} r ,\, k \.{\mapsto}
 seq \.{'} [ r ] ] \} ]}%
\@x{\@s{22.06} \.{\land} SECUpdate ( r ,\, seq [ r ] )}%
 \@x{\@s{22.06} \.{\land} {\UNCHANGED} {\langle} tSet ,\, incoming ,\, msg ,\,
 messageSet {\rangle}}%
\@pvspace{8.0pt}%
\@x{ Remove ( d ,\, r ) \.{\defeq}}%
 \@x{\@s{16.4} \.{\land} \.{\LET} D\@s{3.54} \.{\defeq} \{ ins \.{\in} aSet [
 r ] \.{:} ins . d \.{=} d \}}%
 \@x{\@s{27.51} \.{\IN} \.{\land} aSet \.{'} \.{=} [ aSet {\EXCEPT} {\bang} [
 r ] \.{=} @ \.{\,\backslash\,} D ]}%
 \@x{\@s{47.91} \.{\land} tSet \.{'}\@s{1.78} \.{=} [ tSet {\EXCEPT} {\bang} [
 r ]\@s{1.78} \.{=} @ \.{\cup} D ]}%
 \@x{\@s{16.4} \.{\land} seq \.{'} \.{=} [ seq {\EXCEPT} {\bang} [ r ] \.{=} @
 \.{+} 1 ]}%
\@x{\@s{16.4} \.{\land} SECUpdate ( r ,\, seq [ r ] )}%
 \@x{\@s{16.4} \.{\land} {\UNCHANGED} {\langle} incoming ,\, msg ,\,
 messageSet {\rangle}}%
\@x{}\midbar\@xx{}%
\@x{ Broadcast ( s ,\, m ) \.{\defeq}}%
 \@x{\@s{16.4} [ r \.{\in} Replica \.{\mapsto} {\IF} s \.{=} r \.{\THEN}
 incoming [ s ]}%
\@x{\@s{121.13} \.{\ELSE} incoming [ r ] \.{\circ} {\langle} m {\rangle} ]}%
\@pvspace{8.0pt}%
\@x{ Send ( r ) \.{\defeq}}%
 \@x{\@s{21.98} \.{\land} Network {\bang} NBroadcast ( r ,\, [ r \.{\mapsto} r
 ,\, A \.{\mapsto} aSet [ r ] ,\, T \.{\mapsto} tSet [ r ] ,\, seq
 \.{\mapsto} seq [ r ] ,\,}%
\@x{\@s{33.09} update \.{\mapsto} StateUpdate ( r ) ] )}%
\@x{\@s{21.98} \.{\land} SECSend ( r )}%
 \@x{\@s{21.98} \.{\land} {\UNCHANGED} {\langle} aSet ,\, tSet ,\, seq
 {\rangle}}%
\@pvspace{8.0pt}%
\@x{ Receive ( r ) \.{\defeq}}%
\@x{\@s{16.4} \.{\land}\@s{5.06} Network {\bang} NDeliver ( r )}%
\@x{\@s{16.4} \.{\land}\@s{5.06} SECDeliver ( r ,\, msg \.{'} [ r ] )}%
 \@x{\@s{16.4} \.{\land}\@s{5.06} tSet \.{'}\@s{1.78} \.{=} [ tSet {\EXCEPT}
 {\bang} [ r ]\@s{1.78} \.{=} @ \.{\cup} msg \.{'} [ r ] . T ]}%
 \@x{\@s{16.4} \.{\land}\@s{5.06} aSet \.{'} \.{=} [ aSet {\EXCEPT} {\bang} [
 r ] \.{=} ( @ \.{\cup} msg \.{'} [ r ] . A ) \.{\,\backslash\,} tSet \.{'} [
 r ] ]}%
 \@x{\@s{16.4} \.{\land}\@s{5.06} seq \.{'} \.{=} [ seq {\EXCEPT} {\bang} [ r
 ] \.{=} @ \.{+} 1 ]}%
\@x{\@s{16.4} \.{\land}\@s{5.06} {\UNCHANGED} {\langle} {\rangle}}%
\@x{}\midbar\@xx{}%
\@x{ Next \.{\defeq}}%
 \@x{\@s{16.4} \.{\lor} \E\, r \.{\in} Replica \.{:} \E\, a \.{\in} Data
 \.{:}}%
\@x{\@s{31.61} Add ( a ,\, r ) \.{\lor} Remove ( a ,\, r )}%
\@x{\@s{16.4} \.{\lor} \E\, r \.{\in} Replica \.{:}}%
\@x{\@s{31.61} Send ( r ) \.{\lor} Receive ( r )}%
\@pvspace{8.0pt}%
\@x{ Spec \.{\defeq} Init \.{\land} {\Box} [ Next ]_{ vars}}%
\@x{}\midbar\@xx{}%
\@x{ Read ( r ) \.{\defeq} \{ ins . d \.{:} ins \.{\in} aSet [ r ] \}}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
 \ensuremath{QC}: Quiescent Consistency
}%
\@xx{}%
 \@x{ Quiescence \.{\defeq} \A\, r \.{\in} Replica \.{:} incoming [ r
 ]\@s{1.64} \.{=} {\langle} {\rangle}}%
\@pvspace{8.0pt}%
 \@x{ Convergence \.{\defeq} \A\, r ,\, s \.{\in} Replica \.{:} Read ( r )
 \.{=} Read ( s )}%
\@pvspace{8.0pt}%
\@x{ QC \.{\defeq} Quiescence \.{\implies} Convergence}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
 \ensuremath{SEC}: Strong Eventual Consistency
}%
\@xx{}%
 \@x{ SEC \.{\defeq} \A\, r1 ,\, r2 \.{\in} Replica \.{:} SameUpdate ( r1 ,\,
 r2 ) \.{\implies} Read ( r1 ) \.{=} Read ( r2 )}%
\@x{}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
...
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Last modified \ensuremath{Thu} May 16
 09:19:03 \ensuremath{CST} 2019 by \ensuremath{zfwang
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Last modified Sun \ensuremath{Apr} 28
 15:09:12 \ensuremath{CST} 2019 by \ensuremath{jywellin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created Sun \ensuremath{Apr} 28 14:02:54
 \ensuremath{CST} 2019 by \ensuremath{jywellin
}%
\end{cpar}%
\end{lcom}%
\end{document}
