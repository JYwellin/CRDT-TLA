...
\@x{}\moduleLeftDash\@xx{ {\MODULE} Correctness}\moduleRightDash\@xx{}%
\@x{ {\EXTENDS} Naturals ,\, CRDTInterface ,\, FiniteSets}%
\@x{}\midbar\@xx{}%
\@x{ {\CONSTANTS} Read ( \_ )\@s{4.1}}%
\@y{\@s{0}%
 \ensuremath{Read(r \.{\in} Replica)}: the read operation at \ensuremath{r
}}%
\@xx{}%
\@pvspace{8.0pt}%
 \@x{ UMsg \.{\defeq} [ aid \.{:} Aid ,\, update \.{:} {\SUBSET} Aid
 ]\@s{4.1}}%
\@y{\@s{0}%
 update message type
}%
...
\@pvspace{8.0pt}%
\@x{ CTypeOK \.{\defeq}}%
 \@x{\@s{16.4} \.{\land} doset \.{\in} [ Replica \.{\rightarrow} {\SUBSET} Aid
 ]}%
 \@x{\@s{16.4} \.{\land} delset \.{\in} [ Replica \.{\rightarrow} {\SUBSET}
 Aid ]}%
 \@x{\@s{16.4} \.{\land} uincoming \.{\in} [ Replica \.{\rightarrow} {\SUBSET}
 UMsg ]}%
\@x{}\midbar\@xx{}%
\@x{ CInit \.{\defeq}}%
\@x{\@s{16.4} \.{\land} doset \.{=} [ r \.{\in} Replica \.{\mapsto} \{ \} ]}%
\@x{\@s{16.4} \.{\land} delset \.{=} [ r \.{\in} Replica \.{\mapsto} \{ \} ]}%
 \@x{\@s{16.4} \.{\land} uincoming \.{=} [ r \.{\in} Replica \.{\mapsto} \{ \}
 ]}%
\@pvspace{8.0pt}%
\@x{ CDo ( r ) \.{\defeq}}%
 \@x{\@s{24.33} \.{\land} doset \.{'} \.{=} [ doset {\EXCEPT} {\bang} [ r ]
 \.{=} @ \.{\cup} \{ [ r \.{\mapsto} r ,\, seq \.{\mapsto} seq [ r ] ] \} ]}%
 \@x{\@s{24.33} \.{\land} delset \.{'} \.{=} [ delset {\EXCEPT} {\bang} [ r ]
 \.{=} @ \.{\cup} \{ [ r \.{\mapsto} r ,\, seq \.{\mapsto} seq [ r ] ] \} ]}%
\@x{\@s{24.33} \.{\land} {\UNCHANGED} {\langle} uincoming {\rangle}}%
\@pvspace{8.0pt}%
 \@x{ CSend ( r ) \.{\defeq}\@s{4.1} {\UNCHANGED} {\langle} delset ,\, doset
 {\rangle}\@s{4.1}}%
\@y{\@s{0}%
 implemented by \ensuremath{OpSEC} and \ensuremath{StateSEC
}}%
\@xx{}%
\@pvspace{8.0pt}%
\@x{ CDeliver ( r ,\, aid ) \.{\defeq}\@s{4.1}}%
\@y{\@s{0}%
 choose the update message \ensuremath{um} according to aid
}%
\@xx{}%
 \@x{\@s{16.4} \.{\land} \.{\LET} um \.{\defeq} {\CHOOSE} m \.{\in} uincoming
 [ r ] \.{:} m . aid \.{=} aid}%
\@y{\@s{0}%
 \ensuremath{um} is unique
}%
\@xx{}%
 \@x{\@s{27.51} \.{\IN} delset \.{'} \.{=} [ delset {\EXCEPT} {\bang} [ r ]
 \.{=} @ \.{\cup} um . update ]}%
\@x{\@s{16.4} \.{\land} {\UNCHANGED} {\langle} uincoming ,\, doset {\rangle}}%
\@x{}\midbar\@xx{}%
 \@x{ SEC \.{\defeq} \A\, r1 ,\, r2 \.{\in} Replica \.{:} delset [ r1 ] \.{=}
 delset [ r2 ] \.{\implies} Read ( r1 ) \.{=} Read ( r2 )}%
\@pvspace{8.0pt}%
 \@x{ Liveness \.{\defeq} \A\, aid \.{\in} Aid ,\, r \.{\in} Replica \.{:} aid
 \.{\in} doset [ r ] \.{\leadsto} ( \A\, s \.{\in} Replica \.{:} aid \.{\in}
 delset [ s ] )}%
\@x{}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Aug} 28 17:06:33 \ensuremath{CST} 2019 by \ensuremath{xhdn
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Wed} \ensuremath{Aug} 28
 16:48:45 \ensuremath{CST} 2019 by \ensuremath{xhdn
}%
\end{cpar}%
\end{lcom}%
\end{document}
