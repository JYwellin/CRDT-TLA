...
VARIABLES 
    ...
    delset,    \* uset[r]: the set of updates seen by replica r \in Replica
...
CDeliver(r, aid) ==  \* choose the SEC message um according to aid
...
Liveness == \A aid \in Aid, r \in Replica: aid \in doset[r] ~> (\A s \in Replica : aid \in delset[s])
=============================================================================
\* Modification History
\* Last modified Wed Aug 28 18:16:23 CST 2019 by xhdn
