...
\@x{ {\EXTENDS} Naturals}%
\@x{ {\CONSTANTS} Replica\@s{4.1}}%
\@y{\@s{0}%
 the set of replicas
}%
\@xx{}%
\@x{}\midbar\@xx{}%
\@x{ {\VARIABLES} c ,\,\@s{37.16}}%
\@y{\@s{0}%
 \ensuremath{c[r]}: current value at \ensuremath{r \.{\in} Replica
}}%
\@xx{}%
\@x{\@s{51.42} d ,\,\@s{36.18}}%
\@y{\@s{0}%
 \ensuremath{d[r]}: buffer of increments at \ensuremath{r \.{\in} Replica
}}%
\@xx{}%
\@x{\@s{51.42} incoming\@s{8.19}}%
\@y{\@s{0}%
 \ensuremath{incoming[r]}: incoming channel at replica \ensuremath{r \.{\in}
 Replica
}}%
\@xx{}%
\@x{ Msg \.{\defeq} [ d \.{:} Nat ]\@s{4.1}}%
\@y{\@s{0}%
 message type
}%
\@xx{}%
\@x{ vars \.{\defeq} {\langle} c ,\, d ,\, incoming {\rangle}}%
\@x{}\midbar\@xx{}%
\@x{ TypeOK \.{\defeq}}%
 \@x{\@s{16.4} \.{\land}\@s{9.74} c\@s{0.97} \.{\in} [ Replica \.{\rightarrow}
 Nat ]}%
\@x{\@s{16.4} \.{\land}\@s{9.74} d \.{\in} [ Replica \.{\rightarrow} Nat ]}%
 \@x{\@s{16.4} \.{\land}\@s{9.74} incoming \.{\in} [ Replica \.{\rightarrow}
 Msg ]\@s{4.1}}%
\@y{\@s{0}%
 each incoming channel is represented by a set of message
}%
\@xx{}%
\@x{}\midbar\@xx{}%
\@x{ Init \.{\defeq}}%
\@x{\@s{16.4} \.{\land} c\@s{0.97} \.{=} [ r \.{\in} Replica \.{\mapsto} 0 ]}%
\@x{\@s{16.4} \.{\land} d \.{=} [ r \.{\in} Replica \.{\mapsto} 0 ]}%
...
\@pvspace{8.0pt}%
\@x{ Inc ( r ) \.{\defeq}}%
 \@x{\@s{18.53} \.{\land} c \.{'}\@s{0.97} \.{=} [ c {\EXCEPT} {\bang} [ r
 ]\@s{0.97} \.{=} @ \.{+} 1 ]}%
 \@x{\@s{18.53} \.{\land} d \.{'} \.{=} [ d {\EXCEPT} {\bang} [ r ] \.{=} @
 \.{+} 1 ]}%
\@x{\@s{18.53} \.{\land} {\UNCHANGED} {\langle} incoming {\rangle}}%
\@pvspace{8.0pt}%
\@x{ Do ( r ) \.{\defeq} Inc ( r )\@s{4.1}}%
\@y{\@s{0}%
 We ignore \ensuremath{Read(r)} since it does not modify states.
}%
\@xx{}%
\@x{}\midbar\@xx{}%
\@x{ Send ( r ) \.{\defeq}}%
\@x{\@s{21.98} \.{\land} d [ r ] \.{\neq} 0}%
\@x{\@s{21.98} \.{\land} d \.{'} \.{=} [ d {\EXCEPT} {\bang} [ r ] \.{=} 0 ]}%
 \@x{\@s{21.98} \.{\land} incoming \.{'} \.{=} [ x \.{\in} Replica \.{\mapsto}
 {\IF} x \.{=} r \.{\THEN} incoming [ x ]}%
 \@x{\@s{195.69} \.{\ELSE} incoming [ x ] \.{\cup} [ d \.{\rightarrow} d [ r ]
 ] ]}%
\@x{\@s{21.98} \.{\land} {\UNCHANGED} {\langle} c {\rangle}}%
\@pvspace{8.0pt}%
\@x{ Deliver ( r ) \.{\defeq}}%
\@x{\@s{16.4} \.{\land}\@s{4.75} incoming [ r ] \.{\neq} \{ \}}%
\@x{\@s{16.4} \.{\land}\@s{4.75} \E\, m \.{\in} incoming [ r ] \.{:}\@s{8.2}}%
\@y{\@s{0}%
 choose \ensuremath{m} from \ensuremath{incoming[r]} non-deterministically
}%
\@xx{}%
 \@x{\@s{36.36} \.{\land} c \.{'} \.{=} [ c {\EXCEPT} {\bang} [ r ] \.{=} @
 \.{+} m . d ]}%
 \@x{\@s{36.36} \.{\land} incoming \.{'} \.{=} [ incoming {\EXCEPT} {\bang} [
 r ] \.{=} @ \.{\,\backslash\,} \{ m \} ]\@s{4.1}}%
\@y{\@s{0}%
 delete \ensuremath{m
}}%
\@xx{}%
\@x{\@s{16.4} \.{\land}\@s{4.75} {\UNCHANGED} {\langle} d {\rangle}}%
\@x{}\midbar\@xx{}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Jun} 25 21:01:10 \ensuremath{CST} 2019 by \ensuremath{xhdn
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Thu} \ensuremath{Jun} 20
 22:50:11 \ensuremath{CST} 2019 by \ensuremath{xhdn
}%
\end{cpar}%
\end{lcom}%
\end{document}
