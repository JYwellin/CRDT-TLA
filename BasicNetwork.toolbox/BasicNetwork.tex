...
\@x{}\moduleLeftDash\@xx{ {\MODULE} BasicNetwork}\moduleRightDash\@xx{}%
\@x{ {\EXTENDS} SystemModel}%
\@x{}\midbar\@xx{}%
\@x{ {\VARIABLES} lmsg\@s{4.1}}%
\@y{\@s{0}%
...
\@x{}\midbar\@xx{}%
\@x{ BNInit \.{\defeq}}%
 \@x{\@s{16.4} \.{\land}\@s{3.77} incoming \.{=} [ r \.{\in} Replica
 \.{\mapsto} \{ \} ]}%
 \@x{\@s{16.4} \.{\land}\@s{3.77} lmsg \.{=} [ r \.{\in} Replica \.{\mapsto}
 NotMsg ]}%
\@pvspace{8.0pt}%
\@x{ BNBroadcast ( r ,\, m ) \.{\defeq}}%
 \@x{\@s{16.4} \.{\land} incoming \.{'} \.{=} [ x \.{\in} Replica \.{\mapsto}
 {\IF} x \.{=} r \.{\THEN} incoming [ x ]}%
\@x{\@s{190.10} \.{\ELSE} incoming [ x ] \.{\cup} \{ m \} ]}%
\@x{\@s{16.4} \.{\land} {\UNCHANGED} {\langle} lmsg {\rangle}}%
\@pvspace{8.0pt}%
\@x{ BNDeliver ( r ) \.{\defeq}}%
...
\@xx{}%
 \@x{\@s{16.4} \.{\land} \E\, m \.{\in} incoming [ r ] \.{:} lmsg \.{'} \.{=}
 [ lmsg {\EXCEPT} {\bang} [ r ] \.{=} m ]}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Jun} 17 17:10:47 \ensuremath{CST} 2019 by \ensuremath{xhdn
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created Sun \ensuremath{Jun} 09 20:27:37
