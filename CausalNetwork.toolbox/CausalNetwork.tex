...
\@x{}\midbar\@xx{}%
\@x{ Init \.{\defeq} \.{\land} NInit}%
 \@x{\@s{35.70} \.{\land} vc \.{=} [ r \.{\in} Replica \.{\mapsto} initVector
 ]}%
\@pvspace{8.0pt}%
\@x{ Broadcast ( r ,\, m ) \.{\defeq} \.{\land} NBroadcast ( r ,\, m )}%
 \@x{\@s{90.14} \.{\land} vc \.{'} \.{=} [ vc {\EXCEPT} {\bang} [ r ] [ r ]
 \.{=} @ \.{+} 1 ]}%
\@pvspace{8.0pt}%
\@x{ Deliver ( r ) \.{\defeq}}%
\@x{\@s{16.4} \.{\land}\@s{4.75} incoming [ r ] \.{\neq} EmptyBag}%
 \@x{\@s{16.4} \.{\land}\@s{4.75} \E\, m \.{\in} BagToSet ( incoming [ r ] )
 \.{:}}%
\@x{\@s{40.46} \.{\land} \A\, s \.{\in} Replica \.{:}}%
\@x{\@s{58.79} \.{\lor} m . vc [ s ] \.{\leq} vc [ r ] [ s ]}%
\@x{\@s{58.79} \.{\lor} s \.{\neq} m . r}%
\@x{\@s{40.46} \.{\land} m . vc [ m . r ] \.{=} vc [ r ] [ m . r ] \.{+} 1}%
 \@x{\@s{40.46} \.{\land} vc \.{'} \.{=} [ vc {\EXCEPT} {\bang} [ r ] [ m . r
 ] \.{=} @ \.{+} 1 ]}%
 \@x{\@s{40.46} \.{\land} msg \.{'} \.{=} [ msg {\EXCEPT} {\bang} [ r ] \.{=}
 m ]}%
\@x{\@s{16.4} \.{\land}\@s{4.75} {\UNCHANGED} {\langle} incoming {\rangle}}%
\@x{}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 11:16:58 \ensuremath{CST} 2019 by \ensuremath{zfwang
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Apr} 17 17:47:27 \ensuremath{CST} 2019 by \ensuremath{xhdn
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
