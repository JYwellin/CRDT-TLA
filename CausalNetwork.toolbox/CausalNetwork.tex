...
\@xx{}%
\@x{}\midbar\@xx{}%
\@x{ ts ( m ) \.{\defeq} m . lvc\@s{4.1}}%
\@y{\@s{0}%
 timestamp (vector clock) for \ensuremath{m
}}%
\@xx{}%
\@x{ sender ( m ) \.{\defeq} m . aid . r\@s{4.1}}%
\@y{\@s{0}%
 the replica that sends \ensuremath{m
}}%
\@xx{}%
 \@x{ Max ( a ,\, b )\@s{1.11} \.{\defeq} {\IF} a \.{>} b \.{\THEN} a
 \.{\ELSE} b}%
\@x{}\midbar\@xx{}%
\@x{ CNTypeOK \.{\defeq}}%
\@x{\@s{16.4} \.{\land} SMTypeOK}%
 \@x{\@s{16.4} \.{\land} vc \.{=} [ r \.{\in} Replica \.{\mapsto} [ Replica
...
\@x{ CNBroadcast ( r ,\, m ) \.{\defeq}}%
 ...
 \.{=} @ \.{+} 1 ]}%
 \@x{\@s{16.4} \.{\land} \.{\LET} cm \.{\defeq} [ m {\EXCEPT} {\bang} . lvc
 \.{=} vc \.{'} [ r ] ]}%
\@x{\@s{27.51} \.{\IN} BNBroadcast ( r ,\, cm )}%
\@pvspace{8.0pt}%
\@x{ CNCausallyReady ( r ,\, m ) \.{\defeq}\@s{4.1}}%
\@y{\@s{0}%
 whether \ensuremath{m} is causally ready to be delivered by \ensuremath{r
 \.{\in} Replica
}}%
\@xx{}%
\@x{\@s{16.4} \.{\LET} mr \.{\defeq} sender ( m )}%
 \@x{\@s{16.4} \.{\IN} \.{\land} ts ( m ) [ mr ] \.{\leq} vc [ r ] [ mr ]
 \.{+} 1}%
...
\@x{\@s{16.4} \.{\land} \E\, m \.{\in} incoming [ r ] \.{:}}%
\@x{\@s{35.71} \.{\land} CNCausallyReady ( r ,\, m )}%
\@x{\@s{35.71} \.{\land} \.{\LET} mr \.{\defeq} sender ( m )}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Jun} 18 12:38:28 \ensuremath{CST} 2019 by \ensuremath{xhdn
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
