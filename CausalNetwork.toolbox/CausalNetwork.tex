...
\@x{}\moduleLeftDash\@xx{ {\MODULE} CausalNetwork}\moduleRightDash\@xx{}%
\@x{ {\EXTENDS} BasicNetwork ,\, Naturals}%
\@x{}\midbar\@xx{}%
\@x{ {\VARIABLES}}%
\@x{\@s{16.4} vc\@s{4.1}}%
\@y{\@s{0}%
...
\@xx{}%
\@pvspace{8.0pt}%
\@x{ cnVars \.{\defeq} {\langle} incoming ,\, lmsg ,\, vc {\rangle}}%
\@x{}\midbar\@xx{}%
\@x{ ts ( cm ) \.{\defeq} cm . lvc\@s{4.1}}%
\@y{\@s{0}%
 timestamp (vector clock) for \ensuremath{cm
}}%
\@xx{}%
\@x{ sender ( cm ) \.{\defeq} cm . m . aid . r\@s{4.1}}%
\@y{\@s{0}%
 the replica that sends \ensuremath{cm
}}%
\@xx{}%
\@x{ Max ( a ,\, b ) \.{\defeq} {\IF} a \.{>} b \.{\THEN} a \.{\ELSE} b}%
\@x{}\midbar\@xx{}%
\@x{ CNTypeOK \.{\defeq}}%
\@x{\@s{16.4} \.{\land} SMTypeOK}%
 \@x{\@s{16.4} \.{\land} vc \.{=} [ Replica \.{\rightarrow} [ Replica
 \.{\rightarrow} Nat ] ]\@s{4.1}}%
\@y{\@s{0}%
 \ensuremath{vc[r]} : vector clock at \ensuremath{r \.{\in} Replica
}}%
\@xx{}%
\@x{}\midbar\@xx{}%
\@x{ CNInit \.{\defeq}}%
\@x{\@s{16.4} \.{\land}\@s{3.89} BNInit}%
 \@x{\@s{16.4} \.{\land}\@s{3.89} vc \.{=} [ r \.{\in} Replica \.{\mapsto} [ s
 \.{\in} Replica \.{\mapsto} 0 ] ]\@s{4.1}}%
\@y{\@s{0}%
 \ensuremath{\A\, r}, \ensuremath{s}, \ensuremath{vc[r][s] \.{=} 0
}}%
\@xx{}%
\@pvspace{8.0pt}%
\@x{ CNBroadcast ( r ,\, m ) \.{\defeq}}%
 \@x{\@s{16.4} \.{\land} vc \.{'} \.{=} [ vc {\EXCEPT} {\bang} [ r ] [ r ]
 \.{=} @ \.{+} 1 ]}%
 \@x{\@s{16.4} \.{\land} \.{\LET} cm \.{\defeq} [ m \.{\mapsto} m ,\, lvc
 \.{\mapsto} vc \.{'} [ r ] ]\@s{4.1}}%
\@y{\@s{0}%
 assign \ensuremath{lvc} to \ensuremath{m
}}%
\@xx{}%
\@x{\@s{27.51} \.{\IN} BNBroadcast ( r ,\, cm )}%
\@pvspace{8.0pt}%
\@x{ CNCausallyReady ( r ,\, cm ) \.{\defeq}\@s{4.1}}%
\@y{\@s{0}%
 whether \ensuremath{cm} is causally ready to be delivered by \ensuremath{r
 \.{\in} Replica
}}%
\@xx{}%
\@x{\@s{16.4} \.{\LET} mr \.{\defeq} sender ( cm . m )\@s{4.1}}%
\@y{\@s{0}%
 \ensuremath{cm} : message with vector clock
}%
\@xx{}%
 \@x{\@s{16.4} \.{\IN} \.{\land} ts ( cm ) [ mr ] \.{\leq} vc [ r ] [ mr ]
 \.{+} 1}%
 \@x{\@s{36.79} \.{\land} \A\, s \.{\in} Replica \.{\,\backslash\,} \{ mr \}
 \.{:} ts ( cm ) [ s ] \.{\leq} vc [ r ] [ s ]}%
\@pvspace{8.0pt}%
\@x{ CNDeliver ( r ) \.{\defeq}}%
\@x{\@s{16.4} \.{\land} incoming [ r ] \.{\neq} \{ \}}%
\@x{\@s{16.4} \.{\land} \E\, cm \.{\in} incoming [ r ] \.{:}}%
\@x{\@s{35.71} \.{\land} CNCausallyReady ( r ,\, cm )}%
\@x{\@s{35.71} \.{\land} \.{\LET} mr \.{\defeq} sender ( cm )}%
 \@x{\@s{46.82} \.{\IN} vc \.{'} \.{=} [ vc {\EXCEPT} {\bang} [ r ] [ mr ]
 \.{=} Max ( @ ,\, ts ( cm ) [ mr ] ) ]\@s{4.1}}%
\@y{\@s{0}%
 update \ensuremath{vc[r]
}}%
\@xx{}%
 \@x{\@s{35.71} \.{\land} lmsg \.{'} \.{=} [ lmsg {\EXCEPT} {\bang} [ r ]
 \.{=} cm . m ]}%
\@x{\@s{16.4} \.{\land} {\UNCHANGED} {\langle} incoming {\rangle}}%
\@x{}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Jul} 31 23:10:05 \ensuremath{CST} 2019 by \ensuremath{xhdn
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Last modified \ensuremath{Mon} May 06
 16:07:03 \ensuremath{CST} 2019 by \ensuremath{jywellin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Wed} \ensuremath{Mar} 27
 20:03:44 \ensuremath{CST} 2019 by \ensuremath{jywellin
}%
\end{cpar}%
\end{lcom}%
\end{document}
