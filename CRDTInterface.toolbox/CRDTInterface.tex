...
\@x{}\moduleLeftDash\@xx{ {\MODULE} CRDTInterface}\moduleRightDash\@xx{}%
\@x{ {\EXTENDS} Naturals}%
\@x{ {\CONSTANTS} Replica}%
\@pvspace{8.0pt}%
\@x{ Aid \.{\defeq} [ r \.{:} Replica ,\, seq \.{:} Nat ]\@s{4.1}}%
\@y{\@s{0}%
 action id
}%
\@xx{}%
\@x{}\midbar\@xx{}%
\@x{ {\VARIABLES}\@s{4.1} seq\@s{4.1}}%
\@y{\@s{0}%
 \ensuremath{seq[r]}: local sequence number for actions at replica
 \ensuremath{r \.{\in} Replica
}}%
\@xx{}%
\@x{\@s{8.2}}%
\@y{\@s{0}%
 incremented upon each action (\ensuremath{IntDo}, \ensuremath{IntSend}, and
 \ensuremath{IntDeliver})
}%
\@xx{}%
\@pvspace{8.0pt}%
\@x{ IntTypeOK \.{\defeq} seq \.{\in} [ Replica \.{\rightarrow} Nat ]}%
\@x{}\midbar\@xx{}%
\@x{ IntInit \.{\defeq} seq \.{=} [ r \.{\in} Replica \.{\mapsto} 0 ]}%
\@pvspace{8.0pt}%
 \@x{ IntDo ( r ) \.{\defeq} seq \.{'} \.{=} [ seq {\EXCEPT} {\bang} [ r ]
 \.{=} @ \.{+} 1 ]}%
\@pvspace{8.0pt}%
 \@x{ IntSend ( r ) \.{\defeq} seq \.{'} \.{=} [ seq {\EXCEPT} {\bang} [ r ]
 \.{=} @ \.{+} 1 ]}%
\@pvspace{8.0pt}%
\@x{ IntDeliver ( r ) \.{\defeq} {\UNCHANGED} {\langle} seq {\rangle}}%
\@x{}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Jun} 17 15:02:27 \ensuremath{CST} 2019 by \ensuremath{xhdn
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Mon} \ensuremath{Jun} 17
 14:58:23 \ensuremath{CST} 2019 by \ensuremath{xhdn
}%
\end{cpar}%
\end{lcom}%
\end{document}
