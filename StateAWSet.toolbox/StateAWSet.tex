...
\@x{ secVars \.{\defeq} {\langle} uset ,\, uincoming {\rangle}}%
 \@x{ vars \.{\defeq} {\langle} aset ,\, tset ,\, seq ,\, nVars ,\, secVars
 {\rangle}}%
\@x{}\midbar\@xx{}%
...
\@xx{}%
\@x{ SEC \.{\defeq} {\INSTANCE} StateSEC\@s{4.1}}%
\@y{\@s{0}%
 \ensuremath{{\WITH}} \ensuremath{uset \.{\leftarrow} uset},
 \ensuremath{uincoming \.{\leftarrow} uincoming
}}%
\@xx{}%
\@x{}\midbar\@xx{}%
\@x{ TypeOK \.{\defeq}}%
...
\@x{\@s{16.4} \.{\land} SEC {\bang} StateSECInit}%
\begin{lcom}{0}%
...
\@x{\@s{22.06} \.{\land} SEC {\bang} StateSECDo ( r )}%
...
\@x{\@s{16.4} \.{\land} SEC {\bang} StateSECDo ( r )}%
...
\@x{\@s{21.98} \.{\land} SEC {\bang} StateSECSend ( r )}%
...
\@x{\@s{16.4} \.{\land}\@s{4.75} Network {\bang} BNDeliver ( r )}%
 \@x{\@s{16.4} \.{\land}\@s{4.75} SEC {\bang} StateSECDeliver ( r ,\, lmsg
 \.{'} [ r ] . aid )}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Jun} 26 15:12:53 \ensuremath{CST} 2019 by \ensuremath{xhdn
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
