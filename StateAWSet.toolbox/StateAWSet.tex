...
\@x{}\moduleLeftDash\@xx{ {\MODULE} StateAWSet}\moduleRightDash\@xx{}%
\@x{ {\EXTENDS} AWSet ,\, FiniteSets}%
\@x{ {\CONSTANTS} Read ( \_ ) ,\, InitMsg}%
\@x{}\midbar\@xx{}%
\@x{ {\VARIABLES}}%
\@x{\@s{16.4} aset ,\,\@s{26.26}}%
\@y{\@s{0}%
 \ensuremath{aset[r]}: the set of active elements maintained by \ensuremath{r
 \.{\in} Replica
}}%
\@xx{}%
\@x{\@s{16.4} tset ,\,\@s{28.05}}%
\@y{\@s{0}%
 \ensuremath{tset[r]}: the set of tombstone elements maintained by
...
\@xx{}%
\@x{\@s{16.4} doset ,\,\@s{24.51}}%
\@y{\@s{0}%
 \ensuremath{doset[r]}: the set of updates generated by replica \ensuremath{r
 \.{\in} Replica
}}%
\@xx{}%
\@x{\@s{16.4} delset ,\,\@s{22.46}}%
\@y{\@s{0}%
 \ensuremath{delset[r]}: the set of updates delivered by replica
 \ensuremath{r \.{\in} Replica
}}%
\@xx{}%
\@x{\@s{16.4} uincoming\@s{8.20}}%
\@y{\@s{0}%
...
\@xx{}%
\@pvspace{8.0pt}%
\@x{ nVars\@s{4.1} \.{\defeq} {\langle} incoming ,\, lmsg {\rangle}}%
\@x{ cVars \.{\defeq} {\langle} doset ,\, delset ,\, uincoming {\rangle}}%
 \@x{ vars \.{\defeq} {\langle} aset ,\, tset ,\, seq ,\, nVars ,\, cVars
 {\rangle}}%
\@x{}\midbar\@xx{}%
 \@x{ Msg \.{\defeq} [ aid \.{:} Aid ,\, A \.{:} {\SUBSET} Element ,\, T \.{:}
 {\SUBSET} Element ]}%
\@x{ Network \.{\defeq} {\INSTANCE} BasicNetwork\@s{4.1}}%
\@y{\@s{0}%
 \ensuremath{{\WITH}} \ensuremath{incoming \.{\leftarrow} incoming},
 \ensuremath{lmsg \.{\leftarrow} lmsg
}}%
\@xx{}%
\@pvspace{8.0pt}%
 \@x{ ReadStateAWSet ( r ) \.{\defeq} \{ ele . d \.{:} ele \.{\in} aset [ r ]
 \}\@s{4.1}}%
\@y{\@s{0}%
 read the state of \ensuremath{r\.{\in} Replica
}}%
\@xx{}%
\@x{ Correctness \.{\defeq} {\INSTANCE} StateCorrectness}%
\@x{\@s{74.40}}%
\@y{\@s{0}%
...
\@x{}\midbar\@xx{}%
\@x{ TypeOK \.{\defeq}}%
 \@x{\@s{16.4} \.{\land} aset \.{\in} [ Replica \.{\rightarrow} {\SUBSET}
 Element ]}%
 \@x{\@s{16.4} \.{\land} tset\@s{1.78} \.{\in} [ Replica \.{\rightarrow}
 {\SUBSET} Element ]}%
\@x{\@s{16.4} \.{\land} IntTypeOK}%
\@x{\@s{16.4} \.{\land} Correctness {\bang} CTypeOK}%
\@x{}\midbar\@xx{}%
\@x{ Init \.{\defeq}}%
\@x{\@s{16.4} \.{\land} aset \.{=} [ r \.{\in} Replica \.{\mapsto} \{ \} ]}%
 \@x{\@s{16.4} \.{\land} tset\@s{1.78} \.{=} [ r \.{\in} Replica \.{\mapsto}
 \{ \} ]}%
\@x{\@s{16.4} \.{\land} IntInit}%
\@x{\@s{16.4} \.{\land} Network {\bang} BNInit}%
\@x{\@s{16.4} \.{\land} Correctness {\bang} StateCInit}%
\@x{}\midbar\@xx{}%
...
\@xx{}%
 \@x{\@s{22.06} \.{\land} aset \.{'} \.{=} [ aset {\EXCEPT} {\bang} [ r ]
 \.{=} @ \.{\cup} \{ [ aid \.{\mapsto} [ r \.{\mapsto} r ,\, seq \.{\mapsto}
 seq [ r ] ] ,\, d \.{\mapsto} d ] \} ]}%
\@x{\@s{22.06} \.{\land} IntDo ( r )}%
\@x{\@s{22.06} \.{\land} Correctness {\bang} StateCDo ( r )}%
\@x{\@s{22.06} \.{\land} {\UNCHANGED} {\langle} tset ,\, nVars {\rangle}}%
\@pvspace{8.0pt}%
...
\@xx{}%
 \@x{\@s{27.51} \.{\IN} \.{\land} aset \.{'} \.{=} [ aset {\EXCEPT} {\bang} [
 r ] \.{=} @ \.{\,\backslash\,} E ]}%
 \@x{\@s{47.91} \.{\land} tset \.{'}\@s{1.78} \.{=} [ tset {\EXCEPT} {\bang} [
 r ]\@s{1.78} \.{=} @ \.{\cup} E ]}%
\@x{\@s{16.4} \.{\land} IntDo ( r )}%
\@x{\@s{16.4} \.{\land} Correctness {\bang} StateCDo ( r )}%
\@x{\@s{16.4} \.{\land} {\UNCHANGED} {\langle} nVars {\rangle}}%
\@pvspace{8.0pt}%
\@x{ Do ( r ) \.{\defeq}\@s{4.1}}%
\@y{\@s{0}%
 We ignore \ensuremath{ReadStateAWSet(r)} since it does not modify states.
}%
\@xx{}%
 \@x{\@s{22.47} \E\, a \.{\in} Data \.{:} Add ( a ,\, r ) \.{\lor} Remove ( a
 ,\, r )}%
\@x{}\midbar\@xx{}%
...
\@xx{}%
 \@x{\@s{21.98} \.{\land} Network {\bang} BNBroadcast ( r ,\, [ aid\@s{1.31}
 \.{\mapsto} [ r \.{\mapsto} r ,\, seq \.{\mapsto} seq [ r ] ] ,\,}%
\@x{\@s{158.54} A \.{\mapsto} aset [ r ] ,\, T \.{\mapsto} tset [ r ] ] )}%
\@x{\@s{21.98} \.{\land} IntSend ( r )}%
\@x{\@s{21.98} \.{\land} Correctness {\bang} StateCSend ( r )}%
\@x{\@s{21.98} \.{\land} {\UNCHANGED} {\langle} aset ,\, tset {\rangle}}%
\@pvspace{8.0pt}%
...
\@xx{}%
\@x{\@s{16.4} \.{\land}\@s{4.75} IntDeliver ( r )}%
\@x{\@s{16.4} \.{\land}\@s{4.75} Network {\bang} BNDeliver ( r )}%
 \@x{\@s{16.4} \.{\land}\@s{4.75} Correctness {\bang} StateCDeliver ( r ,\,
 lmsg \.{'} [ r ] . aid )}%
 \@x{\@s{16.4} \.{\land}\@s{4.75} tset \.{'}\@s{1.78} \.{=} [ tset {\EXCEPT}
 {\bang} [ r ]\@s{1.78} \.{=} @ \.{\cup} lmsg \.{'} [ r ] . T ]}%
 \@x{\@s{16.4} \.{\land}\@s{4.75} aset \.{'} \.{=} [ aset {\EXCEPT} {\bang} [
 r ] \.{=} ( @ \.{\cup} lmsg \.{'} [ r ] . A ) \.{\,\backslash\,} tset \.{'}
 [ r ] ]}%
\@x{\@s{16.4} \.{\land}\@s{4.75} {\UNCHANGED} {\langle} {\rangle}}%
\@x{}\midbar\@xx{}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 16:08:31 \ensuremath{CST} 2019 by \ensuremath{xhdn
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Fri} May 24 14:13:38
