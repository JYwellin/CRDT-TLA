...
\@x{ SECvars \.{\defeq} {\langle} updateset ,\, uincoming {\rangle}}%
 \@x{ vars \.{\defeq} {\langle} aset ,\, tset ,\, seq ,\, Nvars ,\, SECvars
 {\rangle}}%
\@x{}\midbar\@xx{}%
 \@x{ Msg \.{\defeq} [ r \.{:} Replica ,\, seq \.{:} Nat ,\, A \.{:} {\SUBSET}
 Element ,\, T \.{:} {\SUBSET} Element ]\@s{4.1}}%
\@y{\@s{0}%
 message type
}%
\@xx{}%
\@x{ Network \.{\defeq} {\INSTANCE} BasicNetwork\@s{169.01}}%
\@y{\@s{0}%
...
\@xx{}%
 \@x{ SEC \.{\defeq} {\INSTANCE} StateSEC {\WITH} data \.{\leftarrow}
 aset\@s{115.02}}%
\@y{\@s{0}%
...
\@xx{}%
 \@x{\@s{21.98} \.{\land} Network {\bang} NBroadcast ( r ,\,\@s{4.1} [ r
 \.{\mapsto} r ,\, seq \.{\mapsto} seq [ r ] ,\,\@s{4.1} A \.{\mapsto} aset [
 r ] ,\, T \.{\mapsto} tset [ r ] ] )}%
\@x{\@s{21.98} \.{\land} IntSend ( r )}%
\@x{\@s{21.98} \.{\land} SEC {\bang} StateSECSend ( r ,\, seq [ r ] )}%
\@x{\@s{21.98} \.{\land} {\UNCHANGED} {\langle} aset ,\, tset {\rangle}}%
\@pvspace{8.0pt}%
\@x{ Deliver ( r ) \.{\defeq}\@s{4.1}}%
\@y{\@s{0}%
 \ensuremath{r\.{\in} Replica} delivers a \ensuremath{message(lmsg\.{'})
}}%
\@xx{}%
\@x{\@s{16.4} \.{\land}\@s{4.75} Network {\bang} NDeliver ( r )}%
\@x{\@s{16.4} \.{\land}\@s{4.75} IntDeliver ( r )}%
 \@x{\@s{16.4} \.{\land}\@s{4.75} SEC {\bang} StateSECDeliver ( r ,\, [ r
 \.{\mapsto} lmsg \.{'} . r ,\, seq \.{\mapsto} lmsg \.{'} . seq ] )}%
 \@x{\@s{16.4} \.{\land}\@s{4.75} tset \.{'}\@s{1.78} \.{=} [ tset {\EXCEPT}
 {\bang} [ r ]\@s{1.78} \.{=} @ \.{\cup} lmsg \.{'} . T ]}%
 \@x{\@s{16.4} \.{\land}\@s{4.75} aset \.{'} \.{=} [ aset {\EXCEPT} {\bang} [
 r ] \.{=} ( @ \.{\cup} lmsg \.{'} . A ) \.{\,\backslash\,} tset \.{'} [ r ]
 ]}%
...
\@x{\@s{22.06} \.{\land} Network {\bang} NDo}%
\@x{\@s{22.06} \.{\land} SEC {\bang} StateSECUpdate ( r ,\, seq [ r ] )}%
\@x{\@s{22.06} \.{\land} {\UNCHANGED} {\langle} tset {\rangle}}%
\@pvspace{8.0pt}%
...
\@x{\@s{16.4} \.{\land} Network {\bang} NDo}%
\@x{\@s{16.4} \.{\land} SEC {\bang} StateSECUpdate ( r ,\, seq [ r ] )}%
\@pvspace{8.0pt}%
\@x{ Do ( r ) \.{\defeq}\@s{32.8}}%
\@y{\@s{0}%
 update operations
...
\@xx{}%
 \@x{\@s{16.4} \E\, r \.{\in} Replica \.{:} Deliver ( r ) \.{\lor} Send ( r )
 \.{\lor} Do ( r )}%
\@pvspace{8.0pt}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Jun} 13 21:34:30 \ensuremath{CST} 2019 by \ensuremath{xhdn
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
