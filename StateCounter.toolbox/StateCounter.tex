...
\@x{}\moduleLeftDash\@xx{ {\MODULE} StateCounter}\moduleRightDash\@xx{}%
\@x{ {\EXTENDS} Naturals ,\, Sequences ,\, Bags ,\, TLC ,\, SEC}%
\@x{}\midbar\@xx{}%
\@x{ {\VARIABLES}}%
\@x{\@s{16.4} counter ,\,\@s{24.90}}%
\@y{\@s{0}%
 \ensuremath{counter[r][s]}: current value of the \ensuremath{Replica[s]} at
 \ensuremath{replica[r]
}}%
\@xx{}%
\@x{\@s{16.4} sendAllowed ,\,\@s{4.1}}%
\@y{\@s{0}%
 \ensuremath{sendAllowed[r]}: is the replica \ensuremath{r \.{\in} Replica}
 allowed to send a message
}%
\@xx{}%
\@x{\@s{16.4} seq ,\,\@s{44.64}}%
\@y{\@s{0}%
 \ensuremath{seq[r]}: local sequence number at replica \ensuremath{r \.{\in}
 Replica
}}%
\@xx{}%
\@x{\@s{16.4} incoming ,\,\@s{18.07}}%
\@y{\@s{0}%
 network variable
}%
\@xx{}%
\@x{\@s{16.4} msg ,\,\@s{40.55}}%
\@y{\@s{0}%
 network variable
}%
\@xx{}%
\@x{\@s{16.4} messageSet\@s{14.66}}%
\@y{\@s{0}%
 network variable
}%
\@xx{}%
\@pvspace{8.0pt}%
 \@x{ vars \.{\defeq} {\langle} counter ,\, sendAllowed ,\, seq ,\, incoming
 ,\, msg ,\, messageSet ,\, SECvars {\rangle}}%
\@pvspace{8.0pt}%
\@x{ Vector \.{\defeq} [ Replica \.{\rightarrow} Nat ]}%
\@x{ InitVector \.{\defeq} [ r \.{\in} Replica \.{\mapsto} 0 ]}%
 \@x{ InitCounter \.{\defeq} counter \.{=} [ r \.{\in} Replica \.{\mapsto}
 InitVector ]}%
 \@x{ Msg \.{\defeq} [ r \.{:} Replica ,\, buf \.{:} Vector ,\, seq \.{:} Nat
...
\@x{ TypeOK \.{\defeq}}%
 ...
 Vector ]}%
 \@x{\@s{16.4} \.{\land}\@s{9.74} sendAllowed \.{\in} [ Replica
 \.{\rightarrow} \{ 0 ,\, 1 \} ]}%
\@x{}\midbar\@xx{}%
\@x{ Init \.{\defeq}}%
\@x{\@s{16.4} \.{\land} InitCounter}%
 \@x{\@s{16.4} \.{\land} sendAllowed \.{=} [ r \.{\in} Replica \.{\mapsto} 0
 ]}%
...
\@x{ Inc ( r ) \.{\defeq}}%
 ...
 \@x{\@s{18.53} \.{\land} sendAllowed \.{'} \.{=} [ sendAllowed {\EXCEPT}
 {\bang} [ r ] \.{=} 1 ]}%
...
\@pvspace{8.0pt}%
\@x{ Send ( r ) \.{\defeq}}%
 \@x{\@s{21.98} \.{\land} sendAllowed \.{'} \.{=} [ sendAllowed {\EXCEPT}
 {\bang} [ r ] \.{=} 0 ]}%
 \@x{\@s{21.98} \.{\land} Network {\bang} NBroadcast ( r ,\, [ r \.{\mapsto} r
 ,\, buf \.{\mapsto} counter [ r ] ,\, seq \.{\mapsto} seq [ r ] ,\,}%
...
\@x{\@s{16.4} \.{\land}\@s{5.06} \A\, s \.{\in} Replica \.{:}}%
 \@x{\@s{44.71} counter \.{'} \.{=} [ counter {\EXCEPT} {\bang} [ r ] [ s ]
 \.{=} SetMax ( @ ,\, msg \.{'} [ r ] . buf [ s ] ) ]}%
 \@x{\@s{16.4} \.{\land}\@s{5.06} {\UNCHANGED} {\langle} sendAllowed ,\, seq
 {\rangle}}%
\@x{}\midbar\@xx{}%
 \@x{ Next \.{\defeq} \.{\land} \E\, r \.{\in} Replica \.{:} Inc ( r )
 \.{\lor} Send ( r ) \.{\lor} Receive ( r )}%
\@x{}\midbar\@xx{}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 09:34:24 \ensuremath{CST} 2019 by \ensuremath{zfwang
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Last modified \ensuremath{Mon} May 06
 15:54:02 \ensuremath{CST} 2019 by \ensuremath{jywellin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Mon} \ensuremath{Mar} 25
 14:25:48 \ensuremath{CST} 2019 by \ensuremath{jywellin
}%
\end{cpar}%
\end{lcom}%
\end{document}
