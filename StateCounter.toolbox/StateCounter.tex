...
\@x{\@s{16.4} update ,\,}%
\@x{\@s{16.4} seq ,\,}%
\@x{\@s{16.4} incoming ,\,\@s{16.4}}%
\@y{\@s{0}%
 network variable
}%
\@xx{}%
\@x{\@s{16.4} msg ,\,\@s{38.88}}%
\@y{\@s{0}%
 network variable
}%
\@xx{}%
\@x{\@s{16.4} messageSet\@s{12.99}}%
\@y{\@s{0}%
 network variable
}%
\@xx{}%
\@pvspace{8.0pt}%
 \@x{ vars \.{\defeq} {\langle} state ,\, update ,\, seq ,\, incoming ,\, msg
 ,\, messageSet ,\, SECvars {\rangle}}%
\@pvspace{8.0pt}%
\@x{ Vector \.{\defeq} [ Replica \.{\rightarrow} Nat ]}%
\@x{ InitVector \.{\defeq} [ r \.{\in} Replica \.{\mapsto} 0 ]}%
 \@x{ InitState \.{\defeq} state \.{=} [ r \.{\in} Replica \.{\mapsto}
 InitVector ]}%
\@x{ EmptyUpdate \.{\defeq} update \.{=} [ r \.{\in} Replica \.{\mapsto} 0 ]}%
...
\@x{}\midbar\@xx{}%
\@x{ TypeOK \.{\defeq}}%
 \@x{\@s{16.4} \.{\land}\@s{9.74} state \.{\in} [ Replica \.{\rightarrow}
 Vector ]}%
 \@x{\@s{16.4} \.{\land}\@s{9.74} update \.{\in} [ Replica \.{\rightarrow} \{
 0 ,\, 1 \} ]}%
\@x{}\midbar\@xx{}%
\@x{ Init \.{\defeq}}%
\@x{\@s{16.4} \.{\land} InitState}%
\@x{\@s{16.4} \.{\land} EmptyUpdate}%
\@x{\@s{16.4} \.{\land} seq \.{=} [ r \.{\in} Replica \.{\mapsto} 0 ]}%
\@x{\@s{16.4} \.{\land} Network {\bang} NInit}%
\@x{\@s{16.4} \.{\land} SECInit}%
\@x{}\midbar\@xx{}%
\@x{ Inc ( r ) \.{\defeq}}%
 \@x{\@s{18.53} \.{\land} state \.{'} \.{=} [ state {\EXCEPT} {\bang} [ r ] [
 r ] \.{=} @ \.{+} 1 ]}%
 \@x{\@s{18.53} \.{\land} update \.{'} \.{=} [ update {\EXCEPT} {\bang} [ r ]
 \.{=} 1 ]}%
...
\@pvspace{8.0pt}%
\@x{ Send ( r ) \.{\defeq}}%
 \@x{\@s{21.98} \.{\land} update \.{'} \.{=} [ update {\EXCEPT} {\bang} [ r ]
 \.{=} 0 ]}%
 \@x{\@s{21.98} \.{\land} Network {\bang} NBroadcast ( r ,\, [ r \.{\mapsto} r
 ,\, vc \.{\mapsto} state [ r ] ,\, seq \.{\mapsto} seq [ r ] ,\, update
 \.{\mapsto} StateUpdate ( r ) ] )}%
\@x{\@s{21.98} \.{\land} SECSend ( r )}%
\@x{\@s{21.98} \.{\land} {\UNCHANGED} {\langle} state ,\, seq {\rangle}}%
\@pvspace{8.0pt}%
\@x{ SetMax ( r ,\, s ) \.{\defeq} {\IF} r \.{>} s \.{\THEN} r \.{\ELSE} s}%
\@pvspace{8.0pt}%
\@x{ Receive ( r ) \.{\defeq}}%
 \@x{\@s{16.4} \.{\land}\@s{5.06} \A\, s \.{\in} Replica \.{:} state \.{'}
 \.{=} [ state {\EXCEPT} {\bang} [ r ] [ s ] \.{=} SetMax ( @ ,\, msg \.{'} [
 r ] . vc [ s ] ) ]}%
\@x{\@s{16.4} \.{\land}\@s{5.06} Network {\bang} NDeliver ( r )}%
\@x{\@s{16.4} \.{\land}\@s{5.06} SECDeliver ( r ,\, msg \.{'} [ r ] )}%
 \@x{\@s{16.4} \.{\land}\@s{5.06} {\UNCHANGED} {\langle} update ,\, seq
 {\rangle}}%
\@x{}\midbar\@xx{}%
...
\@x{}\midbar\@xx{}%
\@x{ SEC \.{\defeq} \E\, r1 ,\, r2 \.{\in} Replica \.{:}}%
 \@x{\@s{21.01} Sameupdate ( r1 ,\, r2 ) \.{\implies} state [ r1 ] \.{=} state
 [ r2 ]}%
\@x{}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 11:24:22 \ensuremath{CST} 2019 by \ensuremath{zfwang
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
