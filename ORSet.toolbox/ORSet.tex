...
\@pvspace{8.0pt}%
 \@x{ Msg \.{\defeq} [ r \.{:} Replica ,\, S \.{:} {\SUBSET} Instance ,\, seq
 \.{:} Nat ,\, update \.{:} {\SUBSET} Update ]}%
\@x{}\midbar\@xx{}%
...
\@x{}\midbar\@xx{}%
\@x{ Add ( d ,\, r ) \.{\defeq}}%
 \@x{\@s{22.06} \.{\land} seq \.{'}\@s{4.91} \.{=} [ seq {\EXCEPT} {\bang} [ r
 ] \.{=} @ \.{+} 1 ]}%
...
\@pvspace{8.0pt}%
\@x{ Remove ( d ,\, r ) \.{\defeq}}%
 \@x{\@s{16.4} \.{\land} \.{\LET} D\@s{3.54} \.{\defeq} \{ ins \.{\in} sSet [
 r ] \.{:} ins . d \.{=} d \}}%
...
\@x{ Send ( r ) \.{\defeq}}%
 ...
 ,\, S \.{\mapsto} sSet [ r ] ,\, seq \.{\mapsto} seq [ r ] ,\,}%
\@x{\@s{33.09} update \.{\mapsto} OpUpdate ( r ) ] )}%
\@x{\@s{21.98} \.{\land} SECSend ( r )}%
\@x{\@s{21.98} \.{\land} {\UNCHANGED} {\langle} sSet ,\, seq {\rangle}}%
\@pvspace{8.0pt}%
\@x{ Receive ( r ) \.{\defeq}}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 10:34:44 \ensuremath{CST} 2019 by \ensuremath{zfwang
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
