...
\@x{}\moduleLeftDash\@xx{ {\MODULE} ORSet}\moduleRightDash\@xx{}%
\@pvspace{8.0pt}%
\@x{ {\EXTENDS} Naturals ,\, Sequences ,\, Bags ,\, TLC ,\, SEC}%
\@pvspace{8.0pt}%
\@x{ {\CONSTANTS}}%
\@x{\@s{16.4} Data\@s{20.5}}%
\@y{\@s{0}%
 the set of data
}%
\@xx{}%
...
\@pvspace{8.0pt}%
\@x{ {\VARIABLES}}%
\@x{\@s{16.4} sSet ,\,\@s{41.0}}%
\@y{\@s{0}%
 \ensuremath{sSet[r]}: set of active \ensuremath{Instance(s)} maintained by
 \ensuremath{r \.{\in} Replica
}}%
\@xx{}%
\@x{\@s{16.4} seq ,\,\@s{45.91}}%
\@y{\@s{0}%
...
\@x{\@s{16.4} messageSet}%
\@pvspace{8.0pt}%
 \@x{ vars \.{\defeq} {\langle} sSet ,\, seq ,\, incoming ,\, msg ,\,
 messageSet ,\, SECvars {\rangle}}%
\@pvspace{8.0pt}%
 \@x{ Msg \.{\defeq} [ r \.{:} Replica ,\, update \.{:} {\SUBSET} Update ,\,
 seq \.{:} Nat ,\, S \.{:} {\SUBSET} Instance ]}%
\@x{}\midbar\@xx{}%
\@pvspace{8.0pt}%
...
\@x{}\midbar\@xx{}%
\@x{ TypeOK \.{\defeq}}%
 \@x{\@s{16.4} \.{\land}\@s{9.74} sSet \.{\in} [ Replica \.{\rightarrow}
 {\SUBSET} Instance ]}%
...
\@x{\@s{16.4} \.{\land} sSet \.{=} [ r \.{\in} Replica \.{\mapsto} \{ \} ]}%
 \@x{\@s{16.4} \.{\land} incoming \.{=} [ r \.{\in} Replica \.{\mapsto}
 {\langle} {\rangle} ]}%
...
\@x{\@s{22.06} \.{\land} SECUpdate ( r ,\, seq [ r ] )}%
 \@x{\@s{22.06} \.{\land} sSet \.{'} \.{=} [ sSet {\EXCEPT} {\bang} [ r ]
...
\@x{\@s{16.4} \.{\land} SECUpdate ( r ,\, seq [ r ] )}%
 \@x{\@s{16.4} \.{\land} \.{\LET} D \.{\defeq} \{ ins \.{\in} sSet [ r ] \.{:}
 ins . d \.{=} d \}}%
 \@x{\@s{27.51} \.{\IN} sSet \.{'} \.{=} [ sSet {\EXCEPT} {\bang} [ r ] \.{=}
 @ \.{\,\backslash\,} D ]}%
...
\@x{ Broadcast ( s ,\, m ) \.{\defeq}}%
 ...
 incoming [ s ]}%
\@x{\@s{121.13} \.{\ELSE} incoming [ r ] \.{\oplus} SetToBag ( \{ m \} ) ]}%
\@pvspace{8.0pt}%
\@x{ Send ( r ) \.{\defeq}}%
 \@x{\@s{21.98} \.{\land} Network {\bang} RBroadcast ( r ,\, [ r \.{\mapsto} r
 ,\, seq \.{\mapsto} seq [ r ] ,\, update \.{\mapsto} OpUpdate ( r ) ,\, S
 \.{\mapsto} sSet [ r ] ] )}%
\@x{\@s{21.98} \.{\land} SECSend ( r )}%
 \@x{\@s{21.98} \.{\land} {\UNCHANGED} {\langle} sSet ,\, seq ,\, sSet
 {\rangle}}%
\@pvspace{8.0pt}%
\@x{ Receive ( r ) \.{\defeq}}%
\@x{\@s{16.4} \.{\land}\@s{5.06} Network {\bang} RDeliver ( r )}%
\@x{\@s{16.4} \.{\land}\@s{5.06} SECDeliver ( r ,\, msg \.{'} [ r ] )}%
 \@x{\@s{16.4} \.{\land}\@s{5.06} sSet \.{'} \.{=} [ sSet {\EXCEPT} {\bang} [
 r ] \.{=} @ \.{\cup} msg \.{'} [ r ] . S ]}%
\@x{\@s{16.4} \.{\land}\@s{5.06} {\UNCHANGED} {\langle} seq {\rangle}}%
\@pvspace{8.0pt}%
\@x{}\midbar\@xx{}%
\@x{ Next \.{\defeq}}%
...
\@x{}\midbar\@xx{}%
\@x{ Read ( r ) \.{\defeq} \{ ins . d \.{:} ins \.{\in} sSet [ r ] \}}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 11:23:35 \ensuremath{CST} 2019 by \ensuremath{zfwang
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Wed} \ensuremath{Feb} 27
 17:23:32 \ensuremath{CST} 2019 by \ensuremath{zfwang
}%
\end{cpar}%
\end{lcom}%
\end{document}
